...
export const EncodingTestForDontOmit = {
  ...
  toJSON(message: EncodingTestForDontOmit): JsonSafe<EncodingTestForDontOmit> {
    ...
    message.salt !== undefined && (obj.salt = message.salt !== undefined ? base64FromBytes(message.salt) : undefined);
    message.dOSalt !== undefined && (obj.dOSalt = base64FromBytes(message.dOSalt !== undefined ? message.dOSalt : new Uint8Array()));
    message.raw !== undefined && (obj.raw = message.raw !== undefined ? base64FromBytes(message.raw) : undefined);
    message.dORaw !== undefined && (obj.dORaw = base64FromBytes(message.dORaw !== undefined ? message.dORaw : new Uint8Array()));
    message.wasm !== undefined && (obj.wasm = message.wasm !== undefined ? base64FromBytes(message.wasm) : undefined);
    ...
    if (message.bigs) {
      obj.bigs = message.bigs.map(e => (e || undefined).toString());
    } else {
      obj.bigs = [];
    }
    if (message.dOBigs) {
    ...
    if (message.salts) {
      obj.salts = message.salts.map(e => base64FromBytes(e !== undefined ? e : undefined));
    } else {
      obj.salts = [];
    }
    if (message.dOSalts) {
    ...
    if (message.raws) {
      obj.raws = message.raws.map(e => base64FromBytes(e !== undefined ? e : undefined));
    } else {
      obj.raws = [];
    }
    if (message.dORaws) {
    ...
    if (message.wasms) {
      obj.wasms = message.wasms.map(e => base64FromBytes(e !== undefined ? e : undefined));
    } else {
      obj.wasms = [];
    }
    if (message.dOWasms) {
  ...
  fromSDKJSON(object: any): EncodingTestForDontOmitSDKType {
    return {
      ...
      b: isSet(object.b) ? Boolean(object.b) : undefined,
      ...
      big: isSet(object.big) ? BigInt(object.big.toString()) : undefined,
      ...
      salt: isSet(object.salt) ? bytesFromBase64(object.salt) : undefined,
      ...
      wasm: isSet(object.wasm) ? bytesFromBase64(object.wasm) : undefined,
