...
export const EvalRequest = {
  ...
  encode(message: EvalRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.falseDeprecated !== undefined) {
  ...
  fromPartial(object: DeepPartial<EvalRequest>): EvalRequest {
    ...
    message.falseDeprecated = object.falseDeprecated ?? undefined;
    return message;
  },
  ...
  fromSDKJSON(object: any): EvalRequestSDKType {
    return {
      ...
      false_deprecated: isSet(object.false_deprecated) ? String(object.false_deprecated) : undefined
    };
  },
