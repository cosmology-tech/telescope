...
export const createGetContractInfo = (getRpcInstance: SigningClientResolver) => buildQuery<QueryContractInfoRequest, QueryContractInfoResponse>({
...
export const createGetContractHistory = (getRpcInstance: SigningClientResolver) => buildQuery<QueryContractHistoryRequest, QueryContractHistoryResponse>({
...
export const createGetContractsByCode = (getRpcInstance: SigningClientResolver) => buildQuery<QueryContractsByCodeRequest, QueryContractsByCodeResponse>({
...
export const createGetAllContractState = (getRpcInstance: SigningClientResolver) => buildQuery<QueryAllContractStateRequest, QueryAllContractStateResponse>({
...
export const createGetRawContractState = (getRpcInstance: SigningClientResolver) => buildQuery<QueryRawContractStateRequest, QueryRawContractStateResponse>({
...
export const createGetSmartContractState = (getRpcInstance: SigningClientResolver) => buildQuery<QuerySmartContractStateRequest, QuerySmartContractStateResponse>({
...
export const createGetCode = (getRpcInstance: SigningClientResolver) => buildQuery<QueryCodeRequest, QueryCodeResponse>({
...
export const createGetCodes = (getRpcInstance: SigningClientResolver) => buildQuery<QueryCodesRequest, QueryCodesResponse>({
...
export const createGetPinnedCodes = (getRpcInstance: SigningClientResolver) => buildQuery<QueryPinnedCodesRequest, QueryPinnedCodesResponse>({
