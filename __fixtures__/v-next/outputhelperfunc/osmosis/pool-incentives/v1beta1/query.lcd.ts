...
export class LCDQueryClient {
  ...
  gaugeIds = async (params: QueryGaugeIdsRequest): Promise<QueryGaugeIdsResponseSDKType> => {
    ...
    return QueryGaugeIdsResponse.fromSDKJSON(await this.req.get<QueryGaugeIdsResponseSDKType>(endpoint));
  };
  ...
  distrInfo = async (_params: QueryDistrInfoRequest = {}): Promise<QueryDistrInfoResponseSDKType> => {
    ...
    return QueryDistrInfoResponse.fromSDKJSON(await this.req.get<QueryDistrInfoResponseSDKType>(endpoint));
  };
  ...
  incentivizedPools = async (_params: QueryIncentivizedPoolsRequest = {}): Promise<QueryIncentivizedPoolsResponseSDKType> => {
    ...
    return QueryIncentivizedPoolsResponse.fromSDKJSON(await this.req.get<QueryIncentivizedPoolsResponseSDKType>(endpoint));
  };
  ...
  externalIncentiveGauges = async (_params: QueryExternalIncentiveGaugesRequest = {}): Promise<QueryExternalIncentiveGaugesResponseSDKType> => {
    ...
    return QueryExternalIncentiveGaugesResponse.fromSDKJSON(await this.req.get<QueryExternalIncentiveGaugesResponseSDKType>(endpoint));
  };
}