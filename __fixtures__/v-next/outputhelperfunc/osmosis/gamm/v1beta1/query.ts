...
export const QueryPoolResponse = {
  ...
  fromSDKJSON(object: any): QueryPoolResponseSDKType {
    return {
      pool: isSet(object.pool) ? GlobalDecoderRegistry.fromSDKJSON(object.pool) : undefined
    };
  },
...
export const QueryPoolsResponse = {
  ...
  fromSDKJSON(object: any): QueryPoolsResponseSDKType {
    return {
      pools: Array.isArray(object?.pools) ? object.pools.map((e: any) => GlobalDecoderRegistry.fromSDKJSON(e)) : [],
