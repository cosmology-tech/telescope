...
export const createRPCQueryClient = async ({
  ...
  return {
    cosmos: {
      ...
      base: {
        reflection: {
          v1beta1: (await import("./base/reflection/v1beta1/reflection.rpc.ReflectionService")).createClientImpl(rpc),
          v2alpha1: (await import("./base/reflection/v2alpha1/reflection.rpc.ReflectionService")).createClientImpl(rpc)
        },
        tendermint: {
