...
export const MsgSubmitProposal = {
  ...
  fromJSON(object: any): MsgSubmitProposal {
    ...
    if (Array.isArray(object?.messages)) obj.messages = object.messages.map((e: any) => GlobalDecoderRegistry.fromJSON(e));
  ...
  fromSDK(object: MsgSubmitProposalSDKType): MsgSubmitProposal {
    return {
      messages: Array.isArray(object?.messages) ? object.messages.map((e: any) => GlobalDecoderRegistry.fromSDK(e)) : [],
  ...
  fromSDKJSON(object: any): MsgSubmitProposalSDKType {
    return {
      messages: Array.isArray(object?.messages) ? object.messages.map((e: any) => GlobalDecoderRegistry.fromSDKJSON(e)) : [],
  ...
  toSDK(message: MsgSubmitProposal): MsgSubmitProposalSDKType {
    const obj: any = {};
    if (message.messages) {
      obj.messages = message.messages.map(e => e ? GlobalDecoderRegistry.toSDK(e) : undefined);
    } else {
      obj.messages = [];
    }
    if (message.initialDeposit) {
...
export const MsgExecLegacyContent = {
  ...
  fromSDKJSON(object: any): MsgExecLegacyContentSDKType {
    return {
      content: isSet(object.content) ? GlobalDecoderRegistry.fromSDKJSON(object.content) : undefined,
