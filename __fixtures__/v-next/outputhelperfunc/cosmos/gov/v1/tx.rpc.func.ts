...
export const createExecLegacyContent = (getSigningClient: SigningClientResolver) => buildTx<ExecLegacyContent>({
  getSigningClient: getSigningClient,
  typeUrl: : MsgExecLegacyContent.typeUrl,
  encoders: toEncoders(ExecLegacyContent),
  converters: toConverters(ExecLegacyContent)
});
export const useExecLegacyContent = buildUseMutation<ExecLegacyContent, Error>({
