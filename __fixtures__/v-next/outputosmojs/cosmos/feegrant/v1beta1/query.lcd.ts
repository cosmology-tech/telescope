...
export class LCDQueryClient {
  ...
  async allowance(params: QueryAllowanceRequest): Promise<QueryAllowanceResponseSDKType> {
    ...
    return QueryAllowanceResponse.fromSDKJSON(await this.req.get<QueryAllowanceResponseSDKType>(endpoint));
  }
  ...
  async allowances(params: QueryAllowancesRequest): Promise<QueryAllowancesResponseSDKType> {
    ...
    return QueryAllowancesResponse.fromSDKJSON(await this.req.get<QueryAllowancesResponseSDKType>(endpoint, options));
  }
  ...
  async allowancesByGranter(params: QueryAllowancesByGranterRequest): Promise<QueryAllowancesByGranterResponseSDKType> {
    ...
    return QueryAllowancesByGranterResponse.fromSDKJSON(await this.req.get<QueryAllowancesByGranterResponseSDKType>(endpoint, options));
  }
}