...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryModuleToDistributeCoinsStore extends QueryStore<ModuleToDistributeCoinsRequest, ModuleToDistributeCoinsResponse> {
    constructor() {
      super(queryService?.moduleToDistributeCoins);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    moduleToDistributeCoins(request?: ModuleToDistributeCoinsRequest): MobxResponse<ModuleToDistributeCoinsResponse> {
      return this.getData(request);
    }

  }

  class QueryGaugeByIDStore extends QueryStore<GaugeByIDRequest, GaugeByIDResponse> {
    constructor() {
      super(queryService?.gaugeByID);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    gaugeByID(request: GaugeByIDRequest): MobxResponse<GaugeByIDResponse> {
      return this.getData(request);
    }

  }

  class QueryGaugesStore extends QueryStore<GaugesRequest, GaugesResponse> {
    constructor() {
      super(queryService?.gauges);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    gauges(request?: GaugesRequest): MobxResponse<GaugesResponse> {
      return this.getData(request);
    }

  }

  class QueryActiveGaugesStore extends QueryStore<ActiveGaugesRequest, ActiveGaugesResponse> {
    constructor() {
      super(queryService?.activeGauges);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    activeGauges(request?: ActiveGaugesRequest): MobxResponse<ActiveGaugesResponse> {
      return this.getData(request);
    }

  }

  class QueryActiveGaugesPerDenomStore extends QueryStore<ActiveGaugesPerDenomRequest, ActiveGaugesPerDenomResponse> {
    constructor() {
      super(queryService?.activeGaugesPerDenom);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    activeGaugesPerDenom(request: ActiveGaugesPerDenomRequest): MobxResponse<ActiveGaugesPerDenomResponse> {
      return this.getData(request);
    }

  }

  class QueryUpcomingGaugesStore extends QueryStore<UpcomingGaugesRequest, UpcomingGaugesResponse> {
    constructor() {
      super(queryService?.upcomingGauges);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    upcomingGauges(request?: UpcomingGaugesRequest): MobxResponse<UpcomingGaugesResponse> {
      return this.getData(request);
    }

  }

  class QueryUpcomingGaugesPerDenomStore extends QueryStore<UpcomingGaugesPerDenomRequest, UpcomingGaugesPerDenomResponse> {
    constructor() {
      super(queryService?.upcomingGaugesPerDenom);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    upcomingGaugesPerDenom(request: UpcomingGaugesPerDenomRequest): MobxResponse<UpcomingGaugesPerDenomResponse> {
      return this.getData(request);
    }

  }

  class QueryRewardsEstStore extends QueryStore<RewardsEstRequest, RewardsEstResponse> {
    constructor() {
      super(queryService?.rewardsEst);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    rewardsEst(request: RewardsEstRequest): MobxResponse<RewardsEstResponse> {
      return this.getData(request);
    }
