...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryConnectionStore extends QueryStore<QueryConnectionRequest, QueryConnectionResponse> {
    constructor() {
      super(queryService?.connection);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    connection(request: QueryConnectionRequest): MobxResponse<QueryConnectionResponse> {
      return this.getData(request);
    }

  }

  class QueryConnectionsStore extends QueryStore<QueryConnectionsRequest, QueryConnectionsResponse> {
    constructor() {
      super(queryService?.connections);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    connections(request?: QueryConnectionsRequest): MobxResponse<QueryConnectionsResponse> {
      return this.getData(request);
    }

  }

  class QueryClientConnectionsStore extends QueryStore<QueryClientConnectionsRequest, QueryClientConnectionsResponse> {
    constructor() {
      super(queryService?.clientConnections);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    clientConnections(request: QueryClientConnectionsRequest): MobxResponse<QueryClientConnectionsResponse> {
      return this.getData(request);
    }

  }

  class QueryConnectionClientStateStore extends QueryStore<QueryConnectionClientStateRequest, QueryConnectionClientStateResponse> {
    constructor() {
      super(queryService?.connectionClientState);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    connectionClientState(request: QueryConnectionClientStateRequest): MobxResponse<QueryConnectionClientStateResponse> {
      return this.getData(request);
    }

  }

  class QueryConnectionConsensusStateStore extends QueryStore<QueryConnectionConsensusStateRequest, QueryConnectionConsensusStateResponse> {
    constructor() {
      super(queryService?.connectionConsensusState);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    connectionConsensusState(request: QueryConnectionConsensusStateRequest): MobxResponse<QueryConnectionConsensusStateResponse> {
      return this.getData(request);
    }
