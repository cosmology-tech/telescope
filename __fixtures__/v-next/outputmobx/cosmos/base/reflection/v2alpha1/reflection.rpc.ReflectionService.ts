...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryGetAuthnDescriptorStore extends QueryStore<GetAuthnDescriptorRequest, GetAuthnDescriptorResponse> {
    constructor() {
      super(queryService?.getAuthnDescriptor);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    getAuthnDescriptor(request?: GetAuthnDescriptorRequest): MobxResponse<GetAuthnDescriptorResponse> {
      return this.getData(request);
    }

  }

  class QueryGetChainDescriptorStore extends QueryStore<GetChainDescriptorRequest, GetChainDescriptorResponse> {
    constructor() {
      super(queryService?.getChainDescriptor);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    getChainDescriptor(request?: GetChainDescriptorRequest): MobxResponse<GetChainDescriptorResponse> {
      return this.getData(request);
    }

  }

  class QueryGetCodecDescriptorStore extends QueryStore<GetCodecDescriptorRequest, GetCodecDescriptorResponse> {
    constructor() {
      super(queryService?.getCodecDescriptor);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    getCodecDescriptor(request?: GetCodecDescriptorRequest): MobxResponse<GetCodecDescriptorResponse> {
      return this.getData(request);
    }

  }

  class QueryGetConfigurationDescriptorStore extends QueryStore<GetConfigurationDescriptorRequest, GetConfigurationDescriptorResponse> {
    constructor() {
      super(queryService?.getConfigurationDescriptor);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    getConfigurationDescriptor(request?: GetConfigurationDescriptorRequest): MobxResponse<GetConfigurationDescriptorResponse> {
      return this.getData(request);
    }

  }

  class QueryGetQueryServicesDescriptorStore extends QueryStore<GetQueryServicesDescriptorRequest, GetQueryServicesDescriptorResponse> {
    constructor() {
      super(queryService?.getQueryServicesDescriptor);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    getQueryServicesDescriptor(request?: GetQueryServicesDescriptorRequest): MobxResponse<GetQueryServicesDescriptorResponse> {
      return this.getData(request);
    }

  }

  class QueryGetTxDescriptorStore extends QueryStore<GetTxDescriptorRequest, GetTxDescriptorResponse> {
    constructor() {
      super(queryService?.getTxDescriptor);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    getTxDescriptor(request?: GetTxDescriptorRequest): MobxResponse<GetTxDescriptorResponse> {
      return this.getData(request);
    }
  ...
  return {
     ...
     * future releases of the cosmos-sdk.
     */
    QueryGetAuthnDescriptorStore,

    /** GetChainDescriptor returns the description of the chain */
    QueryGetChainDescriptorStore,

    /** GetCodecDescriptor returns the descriptor of the codec of the application */
    QueryGetCodecDescriptorStore,

    /** GetConfigurationDescriptor returns the descriptor for the sdk.Config of the application */
    QueryGetConfigurationDescriptorStore,

    /** GetQueryServicesDescriptor returns the available gRPC queryable services of the application */
    QueryGetQueryServicesDescriptorStore,

    /** GetTxDescriptor returns information on the used transaction object and available msgs that can be used */
    QueryGetTxDescriptorStore
  };
};