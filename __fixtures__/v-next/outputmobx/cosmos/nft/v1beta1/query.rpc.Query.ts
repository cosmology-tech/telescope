...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryOwnerStore extends QueryStore<QueryOwnerRequest, QueryOwnerResponse> {
    constructor() {
      super(queryService?.owner);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    owner(request: QueryOwnerRequest): MobxResponse<QueryOwnerResponse> {
      return this.getData(request);
    }

  }

  class QuerySupplyStore extends QueryStore<QuerySupplyRequest, QuerySupplyResponse> {
    constructor() {
      super(queryService?.supply);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    supply(request: QuerySupplyRequest): MobxResponse<QuerySupplyResponse> {
      return this.getData(request);
    }

  }

  class QueryNFTsStore extends QueryStore<QueryNFTsRequest, QueryNFTsResponse> {
    constructor() {
      super(queryService?.nFTs);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    nFTs(request: QueryNFTsRequest): MobxResponse<QueryNFTsResponse> {
      return this.getData(request);
    }

  }

  class QueryNFTStore extends QueryStore<QueryNFTRequest, QueryNFTResponse> {
    constructor() {
      super(queryService?.nFT);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    nFT(request: QueryNFTRequest): MobxResponse<QueryNFTResponse> {
      return this.getData(request);
    }

  }

  class QueryClassStore extends QueryStore<QueryClassRequest, QueryClassResponse> {
    constructor() {
      super(queryService?.class);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    class(request: QueryClassRequest): MobxResponse<QueryClassResponse> {
      return this.getData(request);
    }

  }

  class QueryClassesStore extends QueryStore<QueryClassesRequest, QueryClassesResponse> {
    constructor() {
      super(queryService?.classes);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    classes(request?: QueryClassesRequest): MobxResponse<QueryClassesResponse> {
      return this.getData(request);
    }
