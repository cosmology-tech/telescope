...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryAccountStore extends QueryStore<QueryAccountRequest, QueryAccountResponse> {
    constructor() {
  ...
  class QueryModuleAccountsStore extends QueryStore<QueryModuleAccountsRequest, QueryModuleAccountsResponse> {
    constructor() {
  ...
  class QueryBech32PrefixStore extends QueryStore<Bech32PrefixRequest, Bech32PrefixResponse> {
    constructor() {
  ...
  class QueryAddressBytesToStringStore extends QueryStore<AddressBytesToStringRequest, AddressBytesToStringResponse> {
    constructor() {
  ...
  class QueryAddressStringToBytesStore extends QueryStore<AddressStringToBytesRequest, AddressStringToBytesResponse> {
    constructor() {
