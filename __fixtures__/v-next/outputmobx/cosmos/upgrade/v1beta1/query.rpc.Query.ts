...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryCurrentPlanStore extends QueryStore<QueryCurrentPlanRequest, QueryCurrentPlanResponse> {
    constructor() {
      super(queryService?.currentPlan);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    currentPlan(request?: QueryCurrentPlanRequest): MobxResponse<QueryCurrentPlanResponse> {
      return this.getData(request);
    }

  }

  class QueryAppliedPlanStore extends QueryStore<QueryAppliedPlanRequest, QueryAppliedPlanResponse> {
    constructor() {
      super(queryService?.appliedPlan);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    appliedPlan(request: QueryAppliedPlanRequest): MobxResponse<QueryAppliedPlanResponse> {
      return this.getData(request);
    }
  ...
  class QueryModuleVersionsStore extends QueryStore<QueryModuleVersionsRequest, QueryModuleVersionsResponse> {
    constructor() {
      super(queryService?.moduleVersions);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    moduleVersions(request: QueryModuleVersionsRequest): MobxResponse<QueryModuleVersionsResponse> {
      return this.getData(request);
    }

  }

  class QueryAuthorityStore extends QueryStore<QueryAuthorityRequest, QueryAuthorityResponse> {
    constructor() {
      super(queryService?.authority);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    authority(request?: QueryAuthorityRequest): MobxResponse<QueryAuthorityResponse> {
      return this.getData(request);
    }
