...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryValidatorOutstandingRewardsStore extends QueryStore<QueryValidatorOutstandingRewardsRequest, QueryValidatorOutstandingRewardsResponse> {
    constructor() {
      super(queryService?.validatorOutstandingRewards);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    validatorOutstandingRewards(request: QueryValidatorOutstandingRewardsRequest): MobxResponse<QueryValidatorOutstandingRewardsResponse> {
      return this.getData(request);
    }

  }

  class QueryValidatorCommissionStore extends QueryStore<QueryValidatorCommissionRequest, QueryValidatorCommissionResponse> {
    constructor() {
      super(queryService?.validatorCommission);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    validatorCommission(request: QueryValidatorCommissionRequest): MobxResponse<QueryValidatorCommissionResponse> {
      return this.getData(request);
    }

  }

  class QueryValidatorSlashesStore extends QueryStore<QueryValidatorSlashesRequest, QueryValidatorSlashesResponse> {
    constructor() {
      super(queryService?.validatorSlashes);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    validatorSlashes(request: QueryValidatorSlashesRequest): MobxResponse<QueryValidatorSlashesResponse> {
      return this.getData(request);
    }

  }

  class QueryDelegationRewardsStore extends QueryStore<QueryDelegationRewardsRequest, QueryDelegationRewardsResponse> {
    constructor() {
      super(queryService?.delegationRewards);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    delegationRewards(request: QueryDelegationRewardsRequest): MobxResponse<QueryDelegationRewardsResponse> {
      return this.getData(request);
    }

  }

  class QueryDelegationTotalRewardsStore extends QueryStore<QueryDelegationTotalRewardsRequest, QueryDelegationTotalRewardsResponse> {
    constructor() {
      super(queryService?.delegationTotalRewards);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    delegationTotalRewards(request: QueryDelegationTotalRewardsRequest): MobxResponse<QueryDelegationTotalRewardsResponse> {
      return this.getData(request);
    }
  ...
  class QueryDelegatorWithdrawAddressStore extends QueryStore<QueryDelegatorWithdrawAddressRequest, QueryDelegatorWithdrawAddressResponse> {
    constructor() {
      super(queryService?.delegatorWithdrawAddress);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    delegatorWithdrawAddress(request: QueryDelegatorWithdrawAddressRequest): MobxResponse<QueryDelegatorWithdrawAddressResponse> {
      return this.getData(request);
    }

  }

  class QueryCommunityPoolStore extends QueryStore<QueryCommunityPoolRequest, QueryCommunityPoolResponse> {
    constructor() {
      super(queryService?.communityPool);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    communityPool(request?: QueryCommunityPoolRequest): MobxResponse<QueryCommunityPoolResponse> {
      return this.getData(request);
    }
