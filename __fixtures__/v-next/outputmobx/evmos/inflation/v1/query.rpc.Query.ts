...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryPeriodStore extends QueryStore<QueryPeriodRequest, QueryPeriodResponse> {
    constructor() {
      super(queryService?.period);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    period(request?: QueryPeriodRequest): MobxResponse<QueryPeriodResponse> {
      return this.getData(request);
    }

  }

  class QueryEpochMintProvisionStore extends QueryStore<QueryEpochMintProvisionRequest, QueryEpochMintProvisionResponse> {
    constructor() {
      super(queryService?.epochMintProvision);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    epochMintProvision(request?: QueryEpochMintProvisionRequest): MobxResponse<QueryEpochMintProvisionResponse> {
      return this.getData(request);
    }

  }

  class QuerySkippedEpochsStore extends QueryStore<QuerySkippedEpochsRequest, QuerySkippedEpochsResponse> {
    constructor() {
      super(queryService?.skippedEpochs);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    skippedEpochs(request?: QuerySkippedEpochsRequest): MobxResponse<QuerySkippedEpochsResponse> {
      return this.getData(request);
    }

  }

  class QueryCirculatingSupplyStore extends QueryStore<QueryCirculatingSupplyRequest, QueryCirculatingSupplyResponse> {
    constructor() {
      super(queryService?.circulatingSupply);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    circulatingSupply(request?: QueryCirculatingSupplyRequest): MobxResponse<QueryCirculatingSupplyResponse> {
      return this.getData(request);
    }

  }

  class QueryInflationRateStore extends QueryStore<QueryInflationRateRequest, QueryInflationRateResponse> {
    constructor() {
      super(queryService?.inflationRate);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    inflationRate(request?: QueryInflationRateRequest): MobxResponse<QueryInflationRateResponse> {
      return this.getData(request);
    }
  ...
  return {
    ...
    /** EpochMintProvision retrieves current minting epoch provision value. */
    QueryEpochMintProvisionStore,

    /** SkippedEpochs retrieves the total number of skipped epochs. */
    QuerySkippedEpochsStore,

    /**
     * CirculatingSupply retrieves the total number of tokens that are in
     * circulation (i.e. excluding unvested tokens).
     */
    QueryCirculatingSupplyStore,

    /** InflationRate retrieves the inflation rate of the current period. */
    QueryInflationRateStore,
