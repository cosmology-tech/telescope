...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    ibc: {
      applications: {
        transfer: {
          v1: (await import("./applications/transfer/v1/query.rpc.Query")).QueryClientImpl(rpc)
        }
      },
      core: {
        channel: {
          v1: (await import("./core/channel/v1/query.rpc.Query")).QueryClientImpl(rpc)
        },
        client: {
          v1: (await import("./core/client/v1/query.rpc.Query")).QueryClientImpl(rpc)
        },
        connection: {
          v1: (await import("./core/connection/v1/query.rpc.Query")).QueryClientImpl(rpc)
        },
        port: {
          v1: (await import("./core/port/v1/query.rpc.Query")).QueryClientImpl(rpc)
        }
      }
    }
  };
