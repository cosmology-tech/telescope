...
export class LCDQueryClient {
  ...
  totalUnclaimed = async (_params: QueryTotalUnclaimedRequest = {}): Promise<QueryTotalUnclaimedResponseSDKType> => {
  ...
  claimsRecords = async (params: QueryClaimsRecordsRequest = {
  ...
  claimsRecord = async (params: QueryClaimsRecordRequest): Promise<QueryClaimsRecordResponseSDKType> => {
