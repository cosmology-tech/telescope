...
export const createRPCQueryClient = async ({
  ...
  return {
    akash: {
      audit: {
        v1beta2: (await import("./audit/v1beta2/query.rpc.Query")).QueryClientImpl(rpc)
      },
      cert: {
        v1beta2: (await import("./cert/v1beta2/query.rpc.Query")).QueryClientImpl(rpc)
      },
      deployment: {
        v1beta2: (await import("./deployment/v1beta2/query.rpc.Query")).QueryClientImpl(rpc)
      },
      escrow: {
        v1beta1: (await import("./escrow/v1beta1/query.rpc.Query")).QueryClientImpl(rpc),
        v1beta2: (await import("./escrow/v1beta2/query.rpc.Query")).QueryClientImpl(rpc)
      },
      market: {
        v1beta2: (await import("./market/v1beta2/query.rpc.Query")).QueryClientImpl(rpc)
      },
      provider: {
        v1beta2: (await import("./provider/v1beta2/query.rpc.Query")).QueryClientImpl(rpc)
      }
    },
    cosmos: {
      app: {
