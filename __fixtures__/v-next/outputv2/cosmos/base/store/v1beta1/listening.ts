...
export const StoreKVPair = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number, useInterfaces: boolean = false): StoreKVPair {
  ...
  toAmino(message: StoreKVPair, useInterfaces: boolean = false): StoreKVPairAmino {
    const obj: any = {};
    obj.store_key = message.storeKey;
    obj.delete = message.delete;
    obj.key = message.key;
  ...
  toAminoMsg(message: StoreKVPair, useInterfaces: boolean = false): StoreKVPairAminoMsg {
    return {
      type: "cosmos-sdk/StoreKVPair",
      value: StoreKVPair.toAmino(message, useInterfaces)
    };
  },
  fromProtoMsg(message: StoreKVPairProtoMsg, useInterfaces: boolean = false): StoreKVPair {
