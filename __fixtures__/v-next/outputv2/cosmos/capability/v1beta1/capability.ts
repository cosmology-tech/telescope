...
export const Capability = {
  ...
  toAminoMsg(message: Capability, useInterfaces: boolean = false): CapabilityAminoMsg {
    return {
      type: "cosmos-sdk/Capability",
...
export const Owner = {
  ...
  toAminoMsg(message: Owner, useInterfaces: boolean = false): OwnerAminoMsg {
    return {
      type: "cosmos-sdk/Owner",
...
export const CapabilityOwners = {
  ...
  toAminoMsg(message: CapabilityOwners, useInterfaces: boolean = false): CapabilityOwnersAminoMsg {
    return {
      type: "cosmos-sdk/CapabilityOwners",
