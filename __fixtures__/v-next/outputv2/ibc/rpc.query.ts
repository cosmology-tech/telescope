...
export const createGrpcWebClient = async ({
  ...
  return {
    ...
    ibc: {
      applications: {
        transfer: {
          v1: new (await import("./applications/transfer/v1/query.rpc.Query")).GrpcWebImpl(rpc)
        }
      },
      core: {
        channel: {
          v1: new (await import("./core/channel/v1/query.rpc.Query")).GrpcWebImpl(rpc)
        },
        client: {
          v1: new (await import("./core/client/v1/query.rpc.Query")).GrpcWebImpl(rpc)
        },
        connection: {
          v1: new (await import("./core/connection/v1/query.rpc.Query")).GrpcWebImpl(rpc)
        },
        port: {
          v1: new (await import("./core/port/v1/query.rpc.Query")).GrpcWebImpl(rpc)
        }
      }
    }
  };
