...
import * as _AkashDeploymentV1beta1Querypinia from "./akash/deployment/v1beta1/query.pinia.store";
...
export const createPiniaStores = ({
  ...
  return {
    akash: {
      ...
      deployment: {
        v1beta1: _AkashDeploymentV1beta1Querypinia.usePiniaStore(rpc),
