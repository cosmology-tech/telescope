...
export const SuperfluidAsset = {
  ...
  toAminoMsg(message: SuperfluidAsset, useInterfaces: boolean = true): SuperfluidAssetAminoMsg {
    return {
      type: "osmosis/superfluid-asset",
...
export const SuperfluidIntermediaryAccount = {
  ...
  toAminoMsg(message: SuperfluidIntermediaryAccount, useInterfaces: boolean = true): SuperfluidIntermediaryAccountAminoMsg {
    return {
      type: "osmosis/superfluid-intermediary-account",
...
export const SuperfluidDelegationRecord = {
  ...
  toAminoMsg(message: SuperfluidDelegationRecord, useInterfaces: boolean = true): SuperfluidDelegationRecordAminoMsg {
    return {
      type: "osmosis/superfluid-delegation-record",
...
export const LockIdIntermediaryAccountConnection = {
  ...
  toAminoMsg(message: LockIdIntermediaryAccountConnection, useInterfaces: boolean = true): LockIdIntermediaryAccountConnectionAminoMsg {
    return {
      type: "osmosis/lock-id-intermediary-account-connection",
...
export const UnpoolWhitelistedPools = {
  ...
  toAminoMsg(message: UnpoolWhitelistedPools, useInterfaces: boolean = true): UnpoolWhitelistedPoolsAminoMsg {
    return {
      type: "osmosis/unpool-whitelisted-pools",
