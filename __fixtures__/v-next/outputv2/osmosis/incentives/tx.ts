...
export const MsgCreateGauge = {
  ...
  toAminoMsg(message: MsgCreateGauge, useInterfaces: boolean = false): MsgCreateGaugeAminoMsg {
    return {
      type: "osmosis/incentives/create-gauge",
      value: MsgCreateGauge.toAmino(message, useInterfaces)
    };
  },
...
export const MsgCreateGaugeResponse = {
  ...
  toAminoMsg(message: MsgCreateGaugeResponse, useInterfaces: boolean = false): MsgCreateGaugeResponseAminoMsg {
    return {
      type: "osmosis/incentives/create-gauge-response",
      value: MsgCreateGaugeResponse.toAmino(message, useInterfaces)
    };
  },
...
export const MsgAddToGauge = {
  ...
  toAminoMsg(message: MsgAddToGauge, useInterfaces: boolean = false): MsgAddToGaugeAminoMsg {
    return {
      type: "osmosis/incentives/add-to-gauge",
      value: MsgAddToGauge.toAmino(message, useInterfaces)
    };
  },
...
export const MsgAddToGaugeResponse = {
  ...
  toAminoMsg(message: MsgAddToGaugeResponse, useInterfaces: boolean = false): MsgAddToGaugeResponseAminoMsg {
    return {
      type: "osmosis/incentives/add-to-gauge-response",
      value: MsgAddToGaugeResponse.toAmino(message, useInterfaces)
    };
  },
