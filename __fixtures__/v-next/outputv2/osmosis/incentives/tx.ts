...
export const MsgCreateGauge = {
  ...
  toAminoMsg(message: MsgCreateGauge, useInterfaces: boolean = true): MsgCreateGaugeAminoMsg {
    return {
      type: "osmosis/incentives/create-gauge",
...
export const MsgCreateGaugeResponse = {
  ...
  toAminoMsg(message: MsgCreateGaugeResponse, useInterfaces: boolean = true): MsgCreateGaugeResponseAminoMsg {
    return {
      type: "osmosis/incentives/create-gauge-response",
...
export const MsgAddToGauge = {
  ...
  toAminoMsg(message: MsgAddToGauge, useInterfaces: boolean = true): MsgAddToGaugeAminoMsg {
    return {
      type: "osmosis/incentives/add-to-gauge",
...
export const MsgAddToGaugeResponse = {
  ...
  toAminoMsg(message: MsgAddToGaugeResponse, useInterfaces: boolean = true): MsgAddToGaugeResponseAminoMsg {
    return {
      type: "osmosis/incentives/add-to-gauge-response",
