import { ProposalStatus, ProposalStatusAmino, ProposalStatusAminoType, ProposalStatusSDKType, Proposal, ProposalAmino, ProposalAminoType, ProposalSDKType, Vote, VoteAmino, VoteAminoType, VoteSDKType, VotingParams, VotingParamsAmino, VotingParamsAminoType, VotingParamsSDKType, DepositParams, DepositParamsAmino, DepositParamsAminoType, DepositParamsSDKType, TallyParams, TallyParamsAmino, TallyParamsAminoType, TallyParamsSDKType, Deposit, DepositAmino, DepositAminoType, DepositSDKType, TallyResult, TallyResultAmino, TallyResultAminoType, TallyResultSDKType } from "./gov";
...
import { QueryProposalRequest, QueryProposalRequestAmino, QueryProposalRequestAminoType, QueryProposalRequestSDKType, QueryProposalResponse, QueryProposalResponseAmino, QueryProposalResponseAminoType, QueryProposalResponseSDKType, QueryProposalsRequest, QueryProposalsRequestAmino, QueryProposalsRequestAminoType, QueryProposalsRequestSDKType, QueryProposalsResponse, QueryProposalsResponseAmino, QueryProposalsResponseAminoType, QueryProposalsResponseSDKType, QueryVoteRequest, QueryVoteRequestAmino, QueryVoteRequestAminoType, QueryVoteRequestSDKType, QueryVoteResponse, QueryVoteResponseAmino, QueryVoteResponseAminoType, QueryVoteResponseSDKType, QueryVotesRequest, QueryVotesRequestAmino, QueryVotesRequestAminoType, QueryVotesRequestSDKType, QueryVotesResponse, QueryVotesResponseAmino, QueryVotesResponseAminoType, QueryVotesResponseSDKType, QueryParamsRequest, QueryParamsRequestAmino, QueryParamsRequestAminoType, QueryParamsRequestSDKType, QueryParamsResponse, QueryParamsResponseAmino, QueryParamsResponseAminoType, QueryParamsResponseSDKType, QueryDepositRequest, QueryDepositRequestAmino, QueryDepositRequestAminoType, QueryDepositRequestSDKType, QueryDepositResponse, QueryDepositResponseAmino, QueryDepositResponseAminoType, QueryDepositResponseSDKType, QueryDepositsRequest, QueryDepositsRequestAmino, QueryDepositsRequestAminoType, QueryDepositsRequestSDKType, QueryDepositsResponse, QueryDepositsResponseAmino, QueryDepositsResponseAminoType, QueryDepositsResponseSDKType, QueryTallyResultRequest, QueryTallyResultRequestAmino, QueryTallyResultRequestAminoType, QueryTallyResultRequestSDKType, QueryTallyResultResponse, QueryTallyResultResponseAmino, QueryTallyResultResponseAminoType, QueryTallyResultResponseSDKType } from "./query";
