...
export class Msg {
  static ConnectionOpenInit(): Promise<MsgConnectionOpenInitResponse> {}

  static ConnectionOpenTry(): Promise<MsgConnectionOpenTryResponse> {}

  static ConnectionOpenAck(): Promise<MsgConnectionOpenAckResponse> {}

  static ConnectionOpenConfirm(): Promise<MsgConnectionOpenConfirmResponse> {}
