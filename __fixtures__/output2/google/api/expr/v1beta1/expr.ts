...
export const Expr = {
  ...
  fromAmino(object: ExprSDKType): Expr {
    return {
      ...
      literalExpr: isSet(object.literal_expr) ? Literal.fromAmino(object.literal_expr) : undefined,
  ...
  toAmino(message: Expr): ExprSDKType {
    ...
    message.literalExpr !== undefined && (obj.literal_expr = message.literalExpr ? Literal.toAmino(message.literalExpr) : undefined);
...
export const Literal = {
  ...
  fromAmino(object: LiteralSDKType): Literal {
    return {
  ...
  toAmino(message: Literal): LiteralSDKType {
    const obj: any = {};
