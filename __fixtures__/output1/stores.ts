...
export const createRpcQueryStores = ({
  ...
  return {
    ...
    cosmos: {
      ...
      base: {
        reflection: {
          v1beta1: _CosmosBaseReflectionV1beta1Reflectionrpc.createRpcQueryStores(rpc),
          v2alpha1: _CosmosBaseReflectionV2alpha1Reflectionrpc.createRpcQueryStores(rpc)
        },
        tendermint: {
    ...
    tendermint: {
      abci: _TendermintAbciTypesrpc.createRpcQueryStores(rpc)
    }
  };
};