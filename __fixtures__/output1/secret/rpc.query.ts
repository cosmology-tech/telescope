...
export const createRPCQueryClient = async ({
  ...
  secret: {
    compute: {
      v1beta1: new (await import("./compute/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    },
    registration: {
      v1beta1: new (await import("./registration/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    }
  }
});