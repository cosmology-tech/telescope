export const createRPCQueryClient = async ({
  ...
  ibc: {
    applications: {
      transfer: {
        v1: new (await import("./applications/transfer/v1/query.rpc.query")).RPCQueryClient({
          rpcEndpoint
        })
      }
    },
    core: {
      channel: {
        v1: new (await import("./core/channel/v1/query.rpc.query")).RPCQueryClient({
          rpcEndpoint
        })
      },
      client: {
        v1: new (await import("./core/client/v1/query.rpc.query")).RPCQueryClient({
          rpcEndpoint
        })
      },
      connection: {
        v1: new (await import("./core/connection/v1/query.rpc.query")).RPCQueryClient({
          rpcEndpoint
        })
      },
      port: {
        v1: new (await import("./core/port/v1/query.rpc.query")).RPCQueryClient({
          rpcEndpoint
        })
      }
    }
