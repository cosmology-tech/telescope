...
export const createRpcQueryStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryClientStateStore extends QueryStore<QueryClientStateRequest, QueryClientStateResponse> {
    constructor() {
      super(queryService?.clientState);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    clientState(request: QueryClientStateRequest): MobxResponse<QueryClientStateResponse> {
      return this.getData(request);
    }

  }

  class QueryClientStatesStore extends QueryStore<QueryClientStatesRequest, QueryClientStatesResponse> {
    constructor() {
      super(queryService?.clientStates);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    clientStates(request?: QueryClientStatesRequest): MobxResponse<QueryClientStatesResponse> {
      return this.getData(request);
    }

  }

  class QueryConsensusStateStore extends QueryStore<QueryConsensusStateRequest, QueryConsensusStateResponse> {
    constructor() {
      super(queryService?.consensusState);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    consensusState(request: QueryConsensusStateRequest): MobxResponse<QueryConsensusStateResponse> {
      return this.getData(request);
    }

  }

  class QueryConsensusStatesStore extends QueryStore<QueryConsensusStatesRequest, QueryConsensusStatesResponse> {
    constructor() {
      super(queryService?.consensusStates);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    consensusStates(request: QueryConsensusStatesRequest): MobxResponse<QueryConsensusStatesResponse> {
      return this.getData(request);
    }

  }

  class QueryClientStatusStore extends QueryStore<QueryClientStatusRequest, QueryClientStatusResponse> {
    constructor() {
      super(queryService?.clientStatus);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    clientStatus(request: QueryClientStatusRequest): MobxResponse<QueryClientStatusResponse> {
      return this.getData(request);
    }

  }

  class QueryClientParamsStore extends QueryStore<QueryClientParamsRequest, QueryClientParamsResponse> {
    constructor() {
      super(queryService?.clientParams);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    clientParams(request?: QueryClientParamsRequest): MobxResponse<QueryClientParamsResponse> {
      return this.getData(request);
    }

  }

  class QueryUpgradedClientStateStore extends QueryStore<QueryUpgradedClientStateRequest, QueryUpgradedClientStateResponse> {
    constructor() {
      super(queryService?.upgradedClientState);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    upgradedClientState(request?: QueryUpgradedClientStateRequest): MobxResponse<QueryUpgradedClientStateResponse> {
      return this.getData(request);
    }

  }

  class QueryUpgradedConsensusStateStore extends QueryStore<QueryUpgradedConsensusStateRequest, QueryUpgradedConsensusStateResponse> {
    constructor() {
      super(queryService?.upgradedConsensusState);
      makeObservable(this, {
        state: override,
        request: override,
        response: override,
    ...
    upgradedConsensusState(request?: QueryUpgradedConsensusStateRequest): MobxResponse<QueryUpgradedConsensusStateResponse> {
      return this.getData(request);
    }
