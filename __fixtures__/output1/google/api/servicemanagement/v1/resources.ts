...
/** Code describes the status of the operation (or one of its steps). */
export enum OperationMetadata_StatusSDKType {
  /** STATUS_UNSPECIFIED - Unspecifed code. */
  STATUS_UNSPECIFIED = 0,
...
/** The kind of diagnostic information possible. */
export enum Diagnostic_KindSDKType {
  /** WARNING - Warnings and errors */
  WARNING = 0,
...
export enum ConfigFile_FileTypeSDKType {
  /** FILE_TYPE_UNSPECIFIED - Unknown file type. */
  FILE_TYPE_UNSPECIFIED = 0,
...
/** Status of a Rollout. */
export enum Rollout_RolloutStatusSDKType {
  /** ROLLOUT_STATUS_UNSPECIFIED - No status specified. */
  ROLLOUT_STATUS_UNSPECIFIED = 0,
