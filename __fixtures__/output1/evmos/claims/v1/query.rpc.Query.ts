...
export const createRpcQueryHooks = (rpc: ProtobufRpcClient | undefined) => {
  ...
  return {
    /** TotalUnclaimed queries the total unclaimed tokens from the airdrop */useTotalUnclaimed,
    /** Params returns the claims module parameters */useParams,
    /** ClaimsRecords returns all claims records */useClaimsRecords,
    /** ClaimsRecord returns the claims record for a given address */useClaimsRecord
  };
};