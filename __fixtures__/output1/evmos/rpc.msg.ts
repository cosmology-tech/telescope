export const createRPCMsgClient = async ({
  ...
  evmos: {
    erc20: {
      v1: new (await import("./erc20/v1/tx.rpc.msg")).MsgClientImpl({
        rpc
      })
    },
    fees: {
      v1: new (await import("./fees/v1/tx.rpc.msg")).MsgClientImpl({
        rpc
      })
    },
    vesting: {
      v1: new (await import("./vesting/v1/tx.rpc.msg")).MsgClientImpl({
        rpc
      })
    }
  }
