export const createRPCQueryClient = async ({
  ...
  evmos: {
    claims: {
      v1: new (await import("./claims/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    epochs: {
      v1: new (await import("./epochs/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    erc20: {
      v1: new (await import("./erc20/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    fees: {
      v1: new (await import("./fees/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    incentives: {
      v1: new (await import("./incentives/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    inflation: {
      v1: new (await import("./inflation/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    recovery: {
      v1: new (await import("./recovery/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    vesting: {
      v1: new (await import("./vesting/v1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    }
  }
