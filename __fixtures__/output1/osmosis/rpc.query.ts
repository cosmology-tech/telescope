...
export const createRPCQueryClient = async ({
  ...
  osmosis: {
    claim: {
      v1beta1: new (await import("./claim/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    },
    epochs: {
      v1beta1: new (await import("./epochs/query.rpc.query")).QueryClientImpl(rpc)
    },
    gamm: {
      v1beta1: new (await import("./gamm/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    },
    incentives: new (await import("./incentives/query.rpc.query")).QueryClientImpl(rpc),
    lockup: new (await import("./lockup/query.rpc.query")).QueryClientImpl(rpc),
    mint: {
      v1beta1: new (await import("./mint/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    },
    poolincentives: {
      v1beta1: new (await import("./pool-incentives/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    },
    superfluid: new (await import("./superfluid/query.rpc.query")).QueryClientImpl(rpc),
    tokenfactory: {
      v1beta1: new (await import("./tokenfactory/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    },
    txfees: {
      v1beta1: new (await import("./txfees/v1beta1/query.rpc.query")).QueryClientImpl(rpc)
    }
  }
});