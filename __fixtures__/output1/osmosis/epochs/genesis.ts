...
import { toTimestamp, toDuration, fromTimestamp, fromDuration, Long, isSet, fromJsonTimestamp } from "@osmonauts/helpers";
...
export const EpochInfo = {
  ...
  decode(input: _m0.Reader | Uint8Array): EpochInfo {
