export const createRPCQueryClient = async ({
  ...
  akash: {
    audit: {
      v1beta2: new (await import("./audit/v1beta2/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    cert: {
      v1beta2: new (await import("./cert/v1beta2/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    deployment: {
      v1beta1: new (await import("./deployment/v1beta1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      }),
      v1beta2: new (await import("./deployment/v1beta2/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    escrow: {
      v1beta1: new (await import("./escrow/v1beta1/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      }),
      v1beta2: new (await import("./escrow/v1beta2/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    market: {
      v1beta2: new (await import("./market/v1beta2/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    },
    provider: {
      v1beta2: new (await import("./provider/v1beta2/query.rpc.query")).RPCQueryClient({
        rpcEndpoint
      })
    }
  },
