...
export const createRPCQueryClient = async ({
  ...
  akash: {
    audit: {
      v1beta2: new (await import("./audit/v1beta2/query.rpc.query")).QueryClientImpl(rpc)
    },
    cert: {
      v1beta2: new (await import("./cert/v1beta2/query.rpc.query")).QueryClientImpl(rpc)
    },
    deployment: {
      v1beta1: new (await import("./deployment/v1beta1/query.rpc.query")).QueryClientImpl(rpc),
      v1beta2: new (await import("./deployment/v1beta2/query.rpc.query")).QueryClientImpl(rpc)
    },
    escrow: {
      v1beta1: new (await import("./escrow/v1beta1/query.rpc.query")).QueryClientImpl(rpc),
      v1beta2: new (await import("./escrow/v1beta2/query.rpc.query")).QueryClientImpl(rpc)
    },
    market: {
      v1beta2: new (await import("./market/v1beta2/query.rpc.query")).QueryClientImpl(rpc)
    },
    provider: {
      v1beta2: new (await import("./provider/v1beta2/query.rpc.query")).QueryClientImpl(rpc)
    }
  },
  cosmos: {
    app: {
