export const createRPCMsgClient = async ({
  ...
  akash: {
    audit: {
      v1beta2: new (await import("./audit/v1beta2/query.rpc.query")).RPCMsgClient({
        rpcEndpoint
      })
    },
    cert: {
      v1beta2: new (await import("./cert/v1beta2/query.rpc.query")).RPCMsgClient({
        rpcEndpoint
      })
    },
    deployment: {
      v1beta1: new (await import("./deployment/v1beta1/query.rpc.query")).RPCMsgClient({
        rpcEndpoint
      }),
      v1beta2: new (await import("./deployment/v1beta2/query.rpc.query")).RPCMsgClient({
        rpcEndpoint
      })
    },
    market: {
      v1beta2: new (await import("./market/v1beta2/query.rpc.query")).RPCMsgClient({
        rpcEndpoint
      })
    },
    provider: {
      v1beta2: new (await import("./provider/v1beta2/query.rpc.query")).RPCMsgClient({
        rpcEndpoint
      })
    }
  },
