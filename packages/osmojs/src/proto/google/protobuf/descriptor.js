...
exports.FileDescriptorProto = {
    ...
    fromJSON: function (object) {
        return {
            ...
            publicDependency: Array.isArray(object === null || object === void 0 ? void 0 : object.publicDependency) ? object.publicDependency.map(function (e) { return Number(e); }) : [],
            ...
            messageType: Array.isArray(object === null || object === void 0 ? void 0 : object.messageType) ? object.messageType.map(function (e) { return exports.DescriptorProto.fromJSON(e); }) : [],
            ...
            extension: Array.isArray(object === null || object === void 0 ? void 0 : object.extension) ? object.extension.map(function (e) { return exports.FieldDescriptorProto.fromJSON(e); }) : [],
...
exports.DescriptorProto = {
    ...
    fromJSON: function (object) {
        return {
            ...
            extension: Array.isArray(object === null || object === void 0 ? void 0 : object.extension) ? object.extension.map(function (e) { return exports.FieldDescriptorProto.fromJSON(e); }) : [],
            nestedType: Array.isArray(object === null || object === void 0 ? void 0 : object.nestedType) ? object.nestedType.map(function (e) { return exports.DescriptorProto.fromJSON(e); }) : [],
            enumType: Array.isArray(object === null || object === void 0 ? void 0 : object.enumType) ? object.enumType.map(function (e) { return exports.EnumDescriptorProto.fromJSON(e); }) : [],
            extensionRange: Array.isArray(object === null || object === void 0 ? void 0 : object.extensionRange) ? object.extensionRange.map(function (e) { return exports.DescriptorProto_ExtensionRange.fromJSON(e); }) : [],
            oneofDecl: Array.isArray(object === null || object === void 0 ? void 0 : object.oneofDecl) ? object.oneofDecl.map(function (e) { return exports.OneofDescriptorProto.fromJSON(e); }) : [],
            options: (0, helpers_1.isSet)(object.options) ? exports.MessageOptions.fromJSON(object.options) : undefined,
            reservedRange: Array.isArray(object === null || object === void 0 ? void 0 : object.reservedRange) ? object.reservedRange.map(function (e) { return exports.DescriptorProto_ReservedRange.fromJSON(e); }) : [],
...
exports.ExtensionRangeOptions = {
    ...
    fromJSON: function (object) {
        return {
            uninterpretedOption: Array.isArray(object === null || object === void 0 ? void 0 : object.uninterpretedOption) ? object.uninterpretedOption.map(function (e) { return exports.UninterpretedOption.fromJSON(e); }) : []
        };
    },
    toJSON: function (message) {
        var obj = {};
...
exports.FieldDescriptorProto = {
    ...
    fromPartial: function (object) {
        ...
        message.label = (_c = object.label) !== null && _c !== void 0 ? _c : 0;
...
exports.EnumDescriptorProto = {
    ...
    fromJSON: function (object) {
        return {
            ...
            reservedRange: Array.isArray(object === null || object === void 0 ? void 0 : object.reservedRange) ? object.reservedRange.map(function (e) { return exports.EnumDescriptorProto_EnumReservedRange.fromJSON(e); }) : [],
            reservedName: Array.isArray(object === null || object === void 0 ? void 0 : object.reservedName) ? object.reservedName.map(function (e) { return String(e); }) : []
        };
    },
    toJSON: function (message) {
        ...
        if (message.reservedRange) {
            obj.reservedRange = message.reservedRange.map(function (e) { return e ? exports.EnumDescriptorProto_EnumReservedRange.toJSON(e) : undefined; });
        }
        else {
            obj.reservedRange = [];
        }
...
exports.FileOptions = {
    ...
    fromPartial: function (object) {
        ...
        message.optimizeFor = (_f = object.optimizeFor) !== null && _f !== void 0 ? _f : 0;
...
exports.UninterpretedOption = {
    ...
    fromJSON: function (object) {
        return {
            ...
            positiveIntValue: (0, helpers_1.isSet)(object.positiveIntValue) ? helpers_1.Long.fromString(object.positiveIntValue) : helpers_1.Long.UZERO,
            negativeIntValue: (0, helpers_1.isSet)(object.negativeIntValue) ? helpers_1.Long.fromString(object.negativeIntValue) : helpers_1.Long.ZERO,
...
exports.SourceCodeInfo = {
    ...
    fromJSON: function (object) {
        return {
            location: Array.isArray(object === null || object === void 0 ? void 0 : object.location) ? object.location.map(function (e) { return exports.SourceCodeInfo_Location.fromJSON(e); }) : []
        };
    },
    toJSON: function (message) {
        var obj = {};
...
exports.SourceCodeInfo_Location = {
    ...
    fromJSON: function (object) {
        return {
            ...
            leadingDetachedComments: Array.isArray(object === null || object === void 0 ? void 0 : object.leadingDetachedComments) ? object.leadingDetachedComments.map(function (e) { return String(e); }) : []
        };
    },
    toJSON: function (message) {
        var obj = {};
...
exports.GeneratedCodeInfo = {
    ...
    fromJSON: function (object) {
        return {
            annotation: Array.isArray(object === null || object === void 0 ? void 0 : object.annotation) ? object.annotation.map(function (e) { return exports.GeneratedCodeInfo_Annotation.fromJSON(e); }) : []
        };
    },
    toJSON: function (message) {
        var obj = {};
