...
export declare const getDefaultTSTypeFromProtoType: (type: any, isArray: any) => t.ArrayExpression | t.BooleanLiteral | t.Identifier | t.MemberExpression | t.NewExpression | t.NumericLiteral | t.StringLiteral;
