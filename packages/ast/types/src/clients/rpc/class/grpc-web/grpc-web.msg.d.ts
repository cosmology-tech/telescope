...
export declare const grpcWebRpcInterface: (context: GenericParseContext) => t.ExportNamedDeclaration;
export declare const getGrpcWebImpl: () => t.ExportNamedDeclaration;
