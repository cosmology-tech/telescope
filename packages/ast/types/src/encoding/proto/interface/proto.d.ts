...
export declare const createProtoTypeType: (context: ProtoParseContext, name: string, proto: ProtoType, options?: CreateProtoTypeOptions) => t.ExportNamedDeclaration;
