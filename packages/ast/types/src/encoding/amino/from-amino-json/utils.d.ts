...
export declare const fromAmino: {
    ...
    type({ context, field, currentProtoPath, scope, nested, options }: FromAminoParseField): any;
    typeArray({ context, field, currentProtoPath, scope, nested, options }: FromAminoParseField): t.ObjectProperty;
