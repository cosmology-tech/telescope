...
export declare const rpcNewTmAwaitImport: (path: string, className: string, clientName?: string) => t.CallExpression;
...
export declare const rpcTmNestedImportObject: (obj: object, className: string, clientName?: string) => any;
