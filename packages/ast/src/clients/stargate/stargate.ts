...
export const createStargateClient = ({
  ...
  const includeDefaults = context.pluginValue(
                ...
                t.tsTypeLiteral(
                  [
                    ...
                    t.tsPropertySignature(
                      t.identifier("signer"),
                      t.tsTypeAnnotation(
                        t.tsTypeReference(t.identifier("OfflineSigner"))
                      )
                    ),
...
export const createStargateClientOptions = ({
  ...
  if (includeDefaults) {
    ...
    const funcTypes = t.tsTypeAnnotation(
      t.tsTypeLiteral([prop].filter(Boolean))
    );

    funcArgs = [
      t.assignmentPattern(
        objectPattern(args, funcTypes),
        t.objectExpression([])
      ),
    ];
  }
        ...
        arrowFunctionExpression(
          ...
          t.blockStatement([
            t.variableDeclaration("const", [
              t.variableDeclarator(
                t.identifier("registry"),
                t.newExpression(t.identifier("Registry"), [
                  t.arrayExpression(
                    [
                      includeDefaults &&
            ...
            t.variableDeclaration("const", [
              t.variableDeclarator(
                t.identifier("aminoTypes"),
                t.newExpression(t.identifier("AminoTypes"), [
                  t.objectExpression([
          ...
          t.tsTypeAnnotation(
            t.tsTypeLiteral([
              t.tsPropertySignature(
                t.identifier("registry"),
                t.tsTypeAnnotation(t.tsTypeReference(t.identifier("Registry")))
              ),
              t.tsPropertySignature(
                t.identifier("aminoTypes"),
                t.tsTypeAnnotation(
                  t.tsTypeReference(t.identifier("AminoTypes"))
                )
              ),
            ])
          ),
...
export const createGetTxRpc = (
  ...
  paramExpr.typeAnnotation = t.tsTypeAnnotation(
    t.tsTypeReference(t.identifier("SigningClientParams"))
  );
  ...
  const methodArgs: t.Identifier[] = [
    ...
    identifier(
      "messages",
      t.tsTypeAnnotation(
        t.tsArrayType(t.tsTypeReference(t.identifier("EncodeObject")))
      )
    ),
    identifier(
      "fee",
        ...
        t.arrowFunctionExpression(
          ...
          t.blockStatement(
            [
              ...
              t.variableDeclaration("const", [
                t.variableDeclarator(
                  t.identifier("signingClient"),
                  t.awaitExpression(
                    t.callExpression(t.identifier(clientName), [
                      t.objectExpression([
                        t.objectProperty(
                          t.identifier("rpcEndpoint"),
                          t.identifier("rpcEndpoint"),
