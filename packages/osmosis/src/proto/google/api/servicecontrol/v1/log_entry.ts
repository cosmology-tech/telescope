...
import { LogSeverity, logSeverityFromJSON, logSeverityToJSON } from "../../../../google/logging/type/log_severity";
...
export const LogEntry = {
  encode(message: LogEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.structPayload !== undefined) {
      Struct.encode(Struct.wrap(message.structPayload), writer.uint32(50).fork()).ldelim();
    }
  ...
  toJSON(message: LogEntry): unknown {
    ...
    message.structPayload !== undefined && (obj.structPayload = message.structPayload);
