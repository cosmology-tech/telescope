    ...
    fromPartial<I extends {
        ...
        channel?: {
            ...
            counterparty?: {
                ...
                portId?: string;
                channelId?: string;
            } & Record<Exclude<keyof I["channel"]["counterparty"], keyof import("../../../../ibc/core/channel/v1/channel").Counterparty>, never>;
...
export declare const QueryPacketAcknowledgementsRequest: {
    ...
    fromPartial<I extends {
        ...
        packetCommitmentSequences?: string[] & string[] & Record<Exclude<keyof I["packetCommitmentSequences"], keyof string[]>, never>;
...
export declare const QueryUnreceivedPacketsResponse: {
    ...
    fromPartial<I extends {
        ...
        sequences?: string[] & string[] & Record<Exclude<keyof I["sequences"], keyof string[]>, never>;
        height?: {
            revisionNumber?: string;
            revisionHeight?: string;
        } & {
...
export declare const QueryUnreceivedAcksRequest: {
    ...
    fromPartial<I extends {
        ...
        portId?: string;
        channelId?: string;
        packetAckSequences?: string[] & string[] & Record<Exclude<keyof I["packetAckSequences"], keyof string[]>, never>;
