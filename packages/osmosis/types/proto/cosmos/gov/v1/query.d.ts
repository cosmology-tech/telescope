...
import { Proposal, ProposalStatus, Vote, VotingParams, DepositParams, TallyParams, Deposit, TallyResult } from "../../../cosmos/gov/v1/gov";
    ...
    fromPartial<I extends {
        ...
        vote?: {
            ...
            options?: {
                ...
                option?: import("../../../cosmos/gov/v1/gov").VoteOption;
                weight?: string;
            } & Record<Exclude<keyof I["vote"]["options"][number], keyof import("../../../cosmos/gov/v1/gov").WeightedVoteOption>, never>)[] & Record<Exclude<keyof I["vote"]["options"], keyof {
                option?: import("../../../cosmos/gov/v1/gov").VoteOption;
                weight?: string;
            }[]>, never>;
            metadata?: string;
