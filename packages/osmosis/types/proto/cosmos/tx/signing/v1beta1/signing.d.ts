...
export declare const SignatureDescriptors: {
    ...
    fromPartial<I extends unknown>(object: I): SignatureDescriptors;
};
export declare const SignatureDescriptor: {
    ...
    fromPartial<I extends unknown>(object: I): SignatureDescriptor;
};
export declare const SignatureDescriptor_Data: {
    ...
    fromPartial<I extends unknown>(object: I): SignatureDescriptor_Data;
};
export declare const SignatureDescriptor_Data_Single: {
    ...
    fromPartial<I extends unknown>(object: I): SignatureDescriptor_Data_Single;
};
export declare const SignatureDescriptor_Data_Multi: {
    ...
    fromPartial<I extends unknown>(object: I): SignatureDescriptor_Data_Multi;
};
