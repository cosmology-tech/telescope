...
export declare const QuerySigningInfoRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QuerySigningInfoRequest;
};
export declare const QuerySigningInfoResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QuerySigningInfoResponse;
};
export declare const QuerySigningInfosRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QuerySigningInfosRequest;
};
export declare const QuerySigningInfosResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QuerySigningInfosResponse;
};
