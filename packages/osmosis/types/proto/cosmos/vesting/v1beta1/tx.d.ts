...
export declare const MsgCreateVestingAccountResponse: {
    ...
    fromPartial<I extends unknown>(_: I): MsgCreateVestingAccountResponse;
};
export declare const MsgCreatePermanentLockedAccount: {
    ...
    fromPartial<I extends unknown>(object: I): MsgCreatePermanentLockedAccount;
};
export declare const MsgCreatePermanentLockedAccountResponse: {
    ...
    fromPartial<I extends unknown>(_: I): MsgCreatePermanentLockedAccountResponse;
};
export declare const MsgCreatePeriodicVestingAccount: {
    ...
    fromPartial<I extends unknown>(object: I): MsgCreatePeriodicVestingAccount;
};
export declare const MsgCreatePeriodicVestingAccountResponse: {
    ...
    fromPartial<I extends unknown>(_: I): MsgCreatePeriodicVestingAccountResponse;
};
