...
export declare const QueryGrantsRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QueryGrantsRequest;
};
export declare const QueryGrantsResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QueryGrantsResponse;
};
export declare const QueryGranterGrantsRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QueryGranterGrantsRequest;
};
export declare const QueryGranterGrantsResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QueryGranterGrantsResponse;
};
export declare const QueryGranteeGrantsRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QueryGranteeGrantsRequest;
};
export declare const QueryGranteeGrantsResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QueryGranteeGrantsResponse;
};
