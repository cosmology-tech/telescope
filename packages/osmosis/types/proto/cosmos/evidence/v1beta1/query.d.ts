...
export declare const QueryEvidenceRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QueryEvidenceRequest;
};
export declare const QueryEvidenceResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QueryEvidenceResponse;
};
export declare const QueryAllEvidenceRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QueryAllEvidenceRequest;
};
export declare const QueryAllEvidenceResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QueryAllEvidenceResponse;
};
