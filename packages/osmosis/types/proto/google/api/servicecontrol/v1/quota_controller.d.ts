            ...
            quotaMetrics?: {
                ...
                metricValues?: {
                    ...
                    distributionValue?: {
                        ...
                        maximum?: number;
                        sumOfSquaredDeviation?: number;
                        bucketCounts?: string[] & string[] & Record<Exclude<keyof I["allocateOperation"]["quotaMetrics"][number]["metricValues"][number]["distributionValue"]["bucketCounts"], keyof string[]>, never>;
                        linearBuckets?: {
                            [x: string]: any;
                        } & {
                            [x: string]: any;
                ...
                } & Record<Exclude<keyof I["allocateOperation"]["quotaMetrics"][number]["metricValues"][number], keyof import("../../../../google/api/servicecontrol/v1/metric_value").MetricValue>, never>)[] & Record<Exclude<keyof I["allocateOperation"]["quotaMetrics"][number]["metricValues"], keyof {
                    labels?: {
                        [x: string]: string;
                    };
                    startTime?: Date;
    ...
    fromPartial<I extends {
        ...
        quotaMetrics?: {
            ...
            metricValues?: {
                ...
                [x: string]: any;
            } & Record<Exclude<keyof I["quotaMetrics"][number]["metricValues"][number], keyof import("../../../../google/api/servicecontrol/v1/metric_value").MetricValue>, never>)[] & Record<Exclude<keyof I["quotaMetrics"][number]["metricValues"], keyof {
                labels?: {
                    [x: string]: string;
                };
                startTime?: Date;
