    ...
    fromPartial<I extends {
        ...
        configSource?: {
            ...
            files?: {
                ...
                fileType?: import("../../../../google/api/servicemanagement/v1/resources").ConfigFile_FileType;
            }[];
        };
        validateOnly?: boolean;
    } & {
        ...
        configSource?: {
            ...
            files?: {
                ...
                fileContents?: Uint8Array;
                fileType?: import("../../../../google/api/servicemanagement/v1/resources").ConfigFile_FileType;
            } & Record<Exclude<keyof I["configSource"]["files"][number], keyof import("../../../../google/api/servicemanagement/v1/resources").ConfigFile>, never>)[] & Record<Exclude<keyof I["configSource"]["files"], keyof {
                filePath?: string;
                fileContents?: Uint8Array;
                fileType?: import("../../../../google/api/servicemanagement/v1/resources").ConfigFile_FileType;
            }[]>, never>;
...
export declare const CreateServiceRolloutRequest: {
    ...
    fromPartial<I extends {
        ...
        rollout?: {
            ...
            createTime?: Date;
            createdBy?: string;
            status?: import("../../../../google/api/servicemanagement/v1/resources").Rollout_RolloutStatus;
...
export declare const GenerateConfigReportResponse: {
    ...
    fromPartial<I extends {
        ...
        diagnostics?: {
            location?: string;
            kind?: import("../../../../google/api/servicemanagement/v1/resources").Diagnostic_Kind;
            message?: string;
        }[];
    } & {
        serviceName?: string;
