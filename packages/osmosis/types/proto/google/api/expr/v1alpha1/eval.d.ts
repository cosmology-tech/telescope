    ...
    fromPartial<I extends {
        ...
        value?: {
            ...
            enumValue?: {
                ...
                type?: string;
                value?: number;
            } & Record<Exclude<keyof I["value"]["enumValue"], keyof import("../../../../google/api/expr/v1alpha1/value").EnumValue>, never>;
            objectValue?: {
                typeUrl?: string;
                value?: Uint8Array;
            } & {
            ...
            mapValue?: {
                ...
                entries?: {
                    ...
                    key?: {
                        ...
                        enumValue?: {
                            ...
                            [x: string]: any;
                        } & Record<Exclude<keyof I["value"]["mapValue"]["entries"][number]["key"]["enumValue"], keyof import("../../../../google/api/expr/v1alpha1/value").EnumValue>, never>;
                        objectValue?: {
                            typeUrl?: string;
                            value?: Uint8Array;
                        } & {
                    ...
                    value?: {
                        ...
                        enumValue?: {
                            ...
                            [x: string]: any;
                        } & Record<Exclude<keyof I["value"]["mapValue"]["entries"][number]["value"]["enumValue"], keyof import("../../../../google/api/expr/v1alpha1/value").EnumValue>, never>;
                        objectValue?: {
                            typeUrl?: string;
                            value?: Uint8Array;
                        } & {
                ...
                } & Record<Exclude<keyof I["value"]["mapValue"]["entries"][number], keyof import("../../../../google/api/expr/v1alpha1/value").MapValue_Entry>, never>)[] & Record<Exclude<keyof I["value"]["mapValue"]["entries"], keyof {
                    key?: any;
                    value?: any;
                }[]>, never>;
            ...
            listValue?: {
                ...
                values?: any[] & ({
                    ...
                    enumValue?: {
                        ...
                        type?: string;
                        value?: number;
                    } & Record<Exclude<keyof I["value"]["listValue"]["values"][number]["enumValue"], keyof import("../../../../google/api/expr/v1alpha1/value").EnumValue>, never>;
                    objectValue?: {
                        typeUrl?: string;
                        value?: Uint8Array;
                    } & {
                    ...
                    mapValue?: {
                        ...
                        entries?: {
                            ...
                            [x: string]: any;
                        } & Record<Exclude<keyof I["value"]["listValue"]["values"][number]["mapValue"]["entries"][number], keyof import("../../../../google/api/expr/v1alpha1/value").MapValue_Entry>, never>)[] & Record<Exclude<keyof I["value"]["listValue"]["values"][number]["mapValue"]["entries"], keyof {
                            key?: any;
                            value?: any;
                        }[]>, never>;
        ...
        unknown?: {
            ...
            exprs?: string[] & string[] & Record<Exclude<keyof I["unknown"]["exprs"], keyof string[]>, never>;
...
export declare const UnknownSet: {
    ...
    fromPartial<I extends {
        ...
        exprs?: string[] & string[] & Record<Exclude<keyof I["exprs"], keyof string[]>, never>;
