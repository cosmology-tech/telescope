    ...
    fromPartial<I extends {
        ...
        entries?: {
            ...
            jsonPayload?: {
                ...
                [x: string]: any;
            } & Record<Exclude<keyof I["entries"][number]["jsonPayload"], string | number>, never>;
            timestamp?: Date;
            receiveTimestamp?: Date;
            severity?: import("../type/log_severity").LogSeverity;
            insertId?: string;
            ...
            operation?: {
                ...
                first?: boolean;
                last?: boolean;
            } & Record<Exclude<keyof I["entries"][number]["operation"], keyof import("../../../google/logging/v2/log_entry").LogEntryOperation>, never>;
            trace?: string;
            spanId?: string;
            traceSampled?: boolean;
            sourceLocation?: {
                ...
                line?: string;
                function?: string;
            } & Record<Exclude<keyof I["entries"][number]["sourceLocation"], keyof import("../../../google/logging/v2/log_entry").LogEntrySourceLocation>, never>;
            split?: {
                uid?: string;
                index?: number;
                totalSplits?: number;
                ...
                index?: number;
                totalSplits?: number;
            } & Record<Exclude<keyof I["entries"][number]["split"], keyof import("../../../google/logging/v2/log_entry").LogSplit>, never>;
