...
export function resourceDescriptor_HistoryToJSON(
  object: ResourceDescriptor_History
): string {
  switch (object) {
...
export function resourceDescriptor_StyleFromJSON(
  object: any
...
export function resourceDescriptor_StyleToJSON(
  object: ResourceDescriptor_Style
): string {
  switch (object) {
...
export const ResourceDescriptor = {
  ...
  fromPartial<I extends Exact<DeepPartial<ResourceDescriptor>, I>>(
    object: I
  ): ResourceDescriptor {
    const message = createBaseResourceDescriptor();
