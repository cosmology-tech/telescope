  ...
  fromJSON(object: any): Service {
    return {
      ...
      config: isSet(object.config)
        ? ServiceConfig.fromJSON(object.config)
        : undefined,
  ...
  toJSON(message: Service): unknown {
    ...
    message.config !== undefined &&
      (obj.config = message.config
        ? ServiceConfig.toJSON(message.config)
        : undefined);
...
export const ServiceConfig = {
  encode(
    ...
    for (const v of message.monitoredResources) {
      MonitoredResourceDescriptor.encode(
        v!,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 18:
          ...
          break;
        case 25:
          message.monitoredResources.push(
            MonitoredResourceDescriptor.decode(reader, reader.uint32())
          );
          break;
        case 28:
  ...
  fromJSON(object: any): ServiceConfig {
    return {
      ...
      monitoredResources: Array.isArray(object?.monitoredResources)
        ? object.monitoredResources.map((e: any) =>
            MonitoredResourceDescriptor.fromJSON(e)
          )
        : [],
      monitoring: isSet(object.monitoring)
        ? Monitoring.fromJSON(object.monitoring)
        : undefined,
    };
  },
  ...
  toJSON(message: ServiceConfig): unknown {
    ...
    message.documentation !== undefined &&
      (obj.documentation = message.documentation
        ? Documentation.toJSON(message.documentation)
        : undefined);
    ...
    message.monitoring !== undefined &&
      (obj.monitoring = message.monitoring
        ? Monitoring.toJSON(message.monitoring)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ServiceConfig>, I>>(
    ...
    message.documentation =
      object.documentation !== undefined && object.documentation !== null
    ...
    message.quota =
      object.quota !== undefined && object.quota !== null
        ...
        : undefined;
    message.authentication =
      object.authentication !== undefined && object.authentication !== null
    ...
    message.monitoredResources =
      object.monitoredResources?.map((e) =>
        MonitoredResourceDescriptor.fromPartial(e)
      ) || [];
    message.monitoring =
...
export const ConsumerQuotaMetric = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.consumerQuotaLimits.push(
            ConsumerQuotaLimit.decode(reader, reader.uint32())
          );
          break;
        case 6:
          message.descendantConsumerQuotaLimits.push(
            ConsumerQuotaLimit.decode(reader, reader.uint32())
          );
          break;
        case 5:
  ...
  fromJSON(object: any): ConsumerQuotaMetric {
    return {
      ...
      consumerQuotaLimits: Array.isArray(object?.consumerQuotaLimits)
        ? object.consumerQuotaLimits.map((e: any) =>
            ConsumerQuotaLimit.fromJSON(e)
          )
        : [],
      descendantConsumerQuotaLimits: Array.isArray(
        object?.descendantConsumerQuotaLimits
      )
        ? object.descendantConsumerQuotaLimits.map((e: any) =>
            ConsumerQuotaLimit.fromJSON(e)
          )
        : [],
  ...
  toJSON(message: ConsumerQuotaMetric): unknown {
    ...
    if (message.consumerQuotaLimits) {
      obj.consumerQuotaLimits = message.consumerQuotaLimits.map((e) =>
        e ? ConsumerQuotaLimit.toJSON(e) : undefined
      );
    } else {
    ...
    if (message.descendantConsumerQuotaLimits) {
      obj.descendantConsumerQuotaLimits =
        message.descendantConsumerQuotaLimits.map((e) =>
          e ? ConsumerQuotaLimit.toJSON(e) : undefined
        );
    } else {
      obj.descendantConsumerQuotaLimits = [];
  ...
  fromPartial<I extends Exact<DeepPartial<ConsumerQuotaMetric>, I>>(
    object: I
  ): ConsumerQuotaMetric {
    const message = createBaseConsumerQuotaMetric();
    message.name = object.name ?? "";
    ...
    message.consumerQuotaLimits =
      object.consumerQuotaLimits?.map((e) =>
        ConsumerQuotaLimit.fromPartial(e)
      ) || [];
    message.descendantConsumerQuotaLimits =
      object.descendantConsumerQuotaLimits?.map((e) =>
        ConsumerQuotaLimit.fromPartial(e)
      ) || [];
...
export const ConsumerQuotaLimit = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          break;
        case 9:
          message.quotaBuckets.push(
            QuotaBucket.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): ConsumerQuotaLimit {
    return {
      ...
      allowsAdminOverrides: isSet(object.allowsAdminOverrides)
        ? Boolean(object.allowsAdminOverrides)
        : false,
      quotaBuckets: Array.isArray(object?.quotaBuckets)
  ...
  toJSON(message: ConsumerQuotaLimit): unknown {
    ...
    message.allowsAdminOverrides !== undefined &&
      (obj.allowsAdminOverrides = message.allowsAdminOverrides);
    if (message.quotaBuckets) {
      obj.quotaBuckets = message.quotaBuckets.map((e) =>
        e ? QuotaBucket.toJSON(e) : undefined
      );
    } else {
      obj.quotaBuckets = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ConsumerQuotaLimit>, I>>(
    object: I
  ): ConsumerQuotaLimit {
    const message = createBaseConsumerQuotaLimit();
    message.name = object.name ?? "";
    ...
    message.quotaBuckets =
      object.quotaBuckets?.map((e) => QuotaBucket.fromPartial(e)) || [];
    return message;
  },
};
...
export const QuotaBucket = {
  encode(
    ...
    if (message.producerOverride !== undefined) {
      QuotaOverride.encode(
        message.producerOverride,
        writer.uint32(26).fork()
      ).ldelim();
    }
    if (message.consumerOverride !== undefined) {
      QuotaOverride.encode(
        message.consumerOverride,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.producerOverride = QuotaOverride.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.consumerOverride = QuotaOverride.decode(
            reader,
            reader.uint32()
          );
          break;
        case 5:
          ...
          break;
        case 6:
          const entry6 = QuotaBucket_DimensionsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): QuotaBucket {
    return {
      effectiveLimit: isSet(object.effectiveLimit)
        ? Long.fromString(object.effectiveLimit)
        : Long.ZERO,
      defaultLimit: isSet(object.defaultLimit)
        ? Long.fromString(object.defaultLimit)
        : Long.ZERO,
      producerOverride: isSet(object.producerOverride)
        ? QuotaOverride.fromJSON(object.producerOverride)
        : undefined,
      consumerOverride: isSet(object.consumerOverride)
        ? QuotaOverride.fromJSON(object.consumerOverride)
        : undefined,
      adminOverride: isSet(object.adminOverride)
        ? QuotaOverride.fromJSON(object.adminOverride)
        : undefined,
      dimensions: isObject(object.dimensions)
        ? Object.entries(object.dimensions).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
  ...
  toJSON(message: QuotaBucket): unknown {
    const obj: any = {};
    message.effectiveLimit !== undefined &&
    ...
    message.producerOverride !== undefined &&
      (obj.producerOverride = message.producerOverride
        ? QuotaOverride.toJSON(message.producerOverride)
        : undefined);
    message.consumerOverride !== undefined &&
      (obj.consumerOverride = message.consumerOverride
        ? QuotaOverride.toJSON(message.consumerOverride)
        : undefined);
    message.adminOverride !== undefined &&
      (obj.adminOverride = message.adminOverride
        ? QuotaOverride.toJSON(message.adminOverride)
        : undefined);
    obj.dimensions = {};
  ...
  fromPartial<I extends Exact<DeepPartial<QuotaBucket>, I>>(
    object: I
  ): QuotaBucket {
    const message = createBaseQuotaBucket();
    message.effectiveLimit =
      object.effectiveLimit !== undefined && object.effectiveLimit !== null
    ...
    message.defaultLimit =
      object.defaultLimit !== undefined && object.defaultLimit !== null
        ...
        : Long.ZERO;
    message.producerOverride =
      object.producerOverride !== undefined && object.producerOverride !== null
        ? QuotaOverride.fromPartial(object.producerOverride)
        : undefined;
    message.consumerOverride =
      object.consumerOverride !== undefined && object.consumerOverride !== null
        ? QuotaOverride.fromPartial(object.consumerOverride)
        : undefined;
    message.adminOverride =
      object.adminOverride !== undefined && object.adminOverride !== null
...
export const QuotaBucket_DimensionsEntry = {
  encode(
    message: QuotaBucket_DimensionsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<QuotaBucket_DimensionsEntry>, I>>(
    object: I
  ): QuotaBucket_DimensionsEntry {
    const message = createBaseQuotaBucket_DimensionsEntry();
...
export const QuotaOverride = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = QuotaOverride_DimensionsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): QuotaOverride {
    return {
      name: isSet(object.name) ? String(object.name) : "",
      overrideValue: isSet(object.overrideValue)
        ? Long.fromString(object.overrideValue)
        : Long.ZERO,
      dimensions: isObject(object.dimensions)
        ? Object.entries(object.dimensions).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
      ...
      metric: isSet(object.metric) ? String(object.metric) : "",
      unit: isSet(object.unit) ? String(object.unit) : "",
      adminOverrideAncestor: isSet(object.adminOverrideAncestor)
        ? String(object.adminOverrideAncestor)
        : "",
    };
  },
  ...
  toJSON(message: QuotaOverride): unknown {
    const obj: any = {};
    message.name !== undefined && (obj.name = message.name);
    message.overrideValue !== undefined &&
    ...
    message.metric !== undefined && (obj.metric = message.metric);
    message.unit !== undefined && (obj.unit = message.unit);
    message.adminOverrideAncestor !== undefined &&
      (obj.adminOverrideAncestor = message.adminOverrideAncestor);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QuotaOverride>, I>>(
    object: I
  ): QuotaOverride {
    const message = createBaseQuotaOverride();
    message.name = object.name ?? "";
    message.overrideValue =
      object.overrideValue !== undefined && object.overrideValue !== null
...
export const QuotaOverride_DimensionsEntry = {
  encode(
    message: QuotaOverride_DimensionsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
  ...
  fromPartial<I extends Exact<DeepPartial<QuotaOverride_DimensionsEntry>, I>>(
    object: I
  ): QuotaOverride_DimensionsEntry {
    const message = createBaseQuotaOverride_DimensionsEntry();
    message.key = object.key ?? "";
...
export const OverrideInlineSource = {
  ...
  fromPartial<I extends Exact<DeepPartial<OverrideInlineSource>, I>>(
    object: I
  ): OverrideInlineSource {
    const message = createBaseOverrideInlineSource();
    message.overrides =
...
export const AdminQuotaPolicy = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = AdminQuotaPolicy_DimensionsEntry.decode(
            reader,
            reader.uint32()
          );
          if (entry3.value !== undefined) {
  ...
  fromJSON(object: any): AdminQuotaPolicy {
    return {
      name: isSet(object.name) ? String(object.name) : "",
      policyValue: isSet(object.policyValue)
        ? Long.fromString(object.policyValue)
        : Long.ZERO,
      dimensions: isObject(object.dimensions)
        ? Object.entries(object.dimensions).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<AdminQuotaPolicy>, I>>(
    object: I
  ): AdminQuotaPolicy {
    const message = createBaseAdminQuotaPolicy();
    message.name = object.name ?? "";
    message.policyValue =
      object.policyValue !== undefined && object.policyValue !== null
...
export const AdminQuotaPolicy_DimensionsEntry = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<AdminQuotaPolicy_DimensionsEntry>, I>
  >(object: I): AdminQuotaPolicy_DimensionsEntry {
    const message = createBaseAdminQuotaPolicy_DimensionsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const ServiceIdentity = {
  ...
  fromPartial<I extends Exact<DeepPartial<ServiceIdentity>, I>>(
    object: I
  ): ServiceIdentity {
    const message = createBaseServiceIdentity();
