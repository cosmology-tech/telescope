  ...
  toJSON(message: EnableServiceResponse): unknown {
    ...
    message.service !== undefined &&
      (obj.service = message.service
        ? Service.toJSON(message.service)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<EnableServiceResponse>, I>>(
    object: I
  ): EnableServiceResponse {
    const message = createBaseEnableServiceResponse();
    message.service =
...
export const DisableServiceRequest = {
  ...
  fromJSON(object: any): DisableServiceRequest {
    return {
      ...
      disableDependentServices: isSet(object.disableDependentServices)
        ? Boolean(object.disableDependentServices)
        : false,
      checkIfServiceHasUsage: isSet(object.checkIfServiceHasUsage)
        ? disableServiceRequest_CheckIfServiceHasUsageFromJSON(
            object.checkIfServiceHasUsage
          )
        : 0,
    };
  },
  ...
  toJSON(message: DisableServiceRequest): unknown {
    const obj: any = {};
    message.name !== undefined && (obj.name = message.name);
    message.disableDependentServices !== undefined &&
      (obj.disableDependentServices = message.disableDependentServices);
    message.checkIfServiceHasUsage !== undefined &&
      (obj.checkIfServiceHasUsage =
        disableServiceRequest_CheckIfServiceHasUsageToJSON(
          message.checkIfServiceHasUsage
        ));
    return obj;
  },
...
export const DisableServiceResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<DisableServiceResponse>, I>>(
    object: I
  ): DisableServiceResponse {
    const message = createBaseDisableServiceResponse();
    message.service =
...
export const BatchEnableServicesResponse = {
  encode(
    ...
    for (const v of message.failures) {
      BatchEnableServicesResponse_EnableFailure.encode(
        v!,
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.failures.push(
            BatchEnableServicesResponse_EnableFailure.decode(
              reader,
              reader.uint32()
            )
          );
  ...
  fromJSON(object: any): BatchEnableServicesResponse {
    return {
      services: Array.isArray(object?.services)
        ? object.services.map((e: any) => Service.fromJSON(e))
        : [],
      failures: Array.isArray(object?.failures)
        ? object.failures.map((e: any) =>
            BatchEnableServicesResponse_EnableFailure.fromJSON(e)
          )
        : [],
    };
  },
  ...
  toJSON(message: BatchEnableServicesResponse): unknown {
    ...
    if (message.failures) {
      obj.failures = message.failures.map((e) =>
        e ? BatchEnableServicesResponse_EnableFailure.toJSON(e) : undefined
      );
    } else {
      obj.failures = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<BatchEnableServicesResponse>, I>>(
    object: I
  ): BatchEnableServicesResponse {
    const message = createBaseBatchEnableServicesResponse();
    message.services =
      object.services?.map((e) => Service.fromPartial(e)) || [];
    message.failures =
      object.failures?.map((e) =>
        BatchEnableServicesResponse_EnableFailure.fromPartial(e)
      ) || [];
    return message;
  },
};
...
export const BatchEnableServicesResponse_EnableFailure = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<BatchEnableServicesResponse_EnableFailure>, I>
  >(object: I): BatchEnableServicesResponse_EnableFailure {
    const message = createBaseBatchEnableServicesResponse_EnableFailure();
...
export const BatchGetServicesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<BatchGetServicesRequest>, I>>(
    object: I
  ): BatchGetServicesRequest {
    const message = createBaseBatchGetServicesRequest();
    message.parent = object.parent ?? "";
...
export const BatchGetServicesResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<BatchGetServicesResponse>, I>>(
    object: I
  ): BatchGetServicesResponse {
    const message = createBaseBatchGetServicesResponse();
    message.services =
...
export class ServiceUsageClientImpl implements ServiceUsage {
  ...
  BatchGetServices(
    ...
    return promise.then((data) =>
      BatchGetServicesResponse.decode(new _m0.Reader(data))
    );
  }
}
