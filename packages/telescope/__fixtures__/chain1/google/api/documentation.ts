  ...
  fromJSON(object: any): Documentation {
    return {
      ...
      rules: Array.isArray(object?.rules)
        ? object.rules.map((e: any) => DocumentationRule.fromJSON(e))
        : [],
      documentationRootUrl: isSet(object.documentationRootUrl)
        ? String(object.documentationRootUrl)
        : "",
      serviceRootUrl: isSet(object.serviceRootUrl)
        ? String(object.serviceRootUrl)
        : "",
  ...
  toJSON(message: Documentation): unknown {
    ...
    if (message.rules) {
      obj.rules = message.rules.map((e) =>
        e ? DocumentationRule.toJSON(e) : undefined
      );
    } else {
      obj.rules = [];
    }
    message.documentationRootUrl !== undefined &&
      (obj.documentationRootUrl = message.documentationRootUrl);
    message.serviceRootUrl !== undefined &&
      (obj.serviceRootUrl = message.serviceRootUrl);
    message.overview !== undefined && (obj.overview = message.overview);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Documentation>, I>>(
    object: I
  ): Documentation {
    const message = createBaseDocumentation();
    ...
    message.rules =
      object.rules?.map((e) => DocumentationRule.fromPartial(e)) || [];
...
export const DocumentationRule = {
  ...
  fromJSON(object: any): DocumentationRule {
    return {
      ...
      deprecationDescription: isSet(object.deprecationDescription)
        ? String(object.deprecationDescription)
        : "",
    };
  },
  ...
  toJSON(message: DocumentationRule): unknown {
    ...
    message.deprecationDescription !== undefined &&
      (obj.deprecationDescription = message.deprecationDescription);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<DocumentationRule>, I>>(
    object: I
  ): DocumentationRule {
    const message = createBaseDocumentationRule();
...
export const Page = {
  ...
  fromJSON(object: any): Page {
    return {
      ...
      subpages: Array.isArray(object?.subpages)
        ? object.subpages.map((e: any) => Page.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: Page): unknown {
    ...
    if (message.subpages) {
      obj.subpages = message.subpages.map((e) =>
