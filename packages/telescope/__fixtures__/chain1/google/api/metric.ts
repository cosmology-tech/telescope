...
export function metricDescriptor_MetricKindFromJSON(
  object: any
...
export function metricDescriptor_MetricKindToJSON(
  object: MetricDescriptor_MetricKind
): string {
  switch (object) {
...
export function metricDescriptor_ValueTypeFromJSON(
  object: any
...
export function metricDescriptor_ValueTypeToJSON(
  object: MetricDescriptor_ValueType
): string {
  switch (object) {
...
export const MetricDescriptor = {
  encode(
    ...
    if (message.metadata !== undefined) {
      MetricDescriptor_MetricDescriptorMetadata.encode(
        message.metadata,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          break;
        case 10:
          message.metadata = MetricDescriptor_MetricDescriptorMetadata.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): MetricDescriptor {
    return {
      ...
      labels: Array.isArray(object?.labels)
        ...
        : [],
      metricKind: isSet(object.metricKind)
        ? metricDescriptor_MetricKindFromJSON(object.metricKind)
        : 0,
      valueType: isSet(object.valueType)
        ? metricDescriptor_ValueTypeFromJSON(object.valueType)
        : 0,
      ...
      launchStage: isSet(object.launchStage)
        ...
        : 0,
      monitoredResourceTypes: Array.isArray(object?.monitoredResourceTypes)
        ? object.monitoredResourceTypes.map((e: any) => String(e))
        : [],
    };
  },
  ...
  toJSON(message: MetricDescriptor): unknown {
    ...
    message.metadata !== undefined &&
      (obj.metadata = message.metadata
        ? MetricDescriptor_MetricDescriptorMetadata.toJSON(message.metadata)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<MetricDescriptor>, I>>(
    object: I
  ): MetricDescriptor {
    const message = createBaseMetricDescriptor();
    ...
    message.metadata =
      object.metadata !== undefined && object.metadata !== null
        ? MetricDescriptor_MetricDescriptorMetadata.fromPartial(object.metadata)
        : undefined;
    message.launchStage = object.launchStage ?? 0;
    message.monitoredResourceTypes =
      object.monitoredResourceTypes?.map((e) => e) || [];
    return message;
  },
};
...
export const MetricDescriptor_MetricDescriptorMetadata = {
  ...
  fromJSON(object: any): MetricDescriptor_MetricDescriptorMetadata {
    return {
      launchStage: isSet(object.launchStage)
        ? launchStageFromJSON(object.launchStage)
        : 0,
      samplePeriod: isSet(object.samplePeriod)
        ? Duration.fromJSON(object.samplePeriod)
        : undefined,
      ingestDelay: isSet(object.ingestDelay)
        ? Duration.fromJSON(object.ingestDelay)
        : undefined,
    };
  },
  ...
  toJSON(message: MetricDescriptor_MetricDescriptorMetadata): unknown {
    ...
    message.launchStage !== undefined &&
      (obj.launchStage = launchStageToJSON(message.launchStage));
    message.samplePeriod !== undefined &&
      (obj.samplePeriod = message.samplePeriod
        ? Duration.toJSON(message.samplePeriod)
        : undefined);
    message.ingestDelay !== undefined &&
      (obj.ingestDelay = message.ingestDelay
        ? Duration.toJSON(message.ingestDelay)
        : undefined);
    return obj;
  },

  fromPartial<
    I extends Exact<DeepPartial<MetricDescriptor_MetricDescriptorMetadata>, I>
  >(object: I): MetricDescriptor_MetricDescriptorMetadata {
    const message = createBaseMetricDescriptor_MetricDescriptorMetadata();
    message.launchStage = object.launchStage ?? 0;
    message.samplePeriod =
      object.samplePeriod !== undefined && object.samplePeriod !== null
        ? Duration.fromPartial(object.samplePeriod)
        : undefined;
    message.ingestDelay =
      object.ingestDelay !== undefined && object.ingestDelay !== null
        ? Duration.fromPartial(object.ingestDelay)
        : undefined;
    return message;
  },
};
...
export const Metric_LabelsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<Metric_LabelsEntry>, I>>(
    object: I
  ): Metric_LabelsEntry {
    const message = createBaseMetric_LabelsEntry();
