...
export function backendRule_PathTranslationFromJSON(
  object: any
...
export function backendRule_PathTranslationToJSON(
  object: BackendRule_PathTranslation
): string {
  switch (object) {
  ...
  toJSON(message: Backend): unknown {
    ...
    if (message.rules) {
      obj.rules = message.rules.map((e) =>
        e ? BackendRule.toJSON(e) : undefined
      );
    } else {
      obj.rules = [];
    }
...
export const BackendRule = {
  ...
  fromJSON(object: any): BackendRule {
    return {
      ...
      operationDeadline: isSet(object.operationDeadline)
        ? Number(object.operationDeadline)
        : 0,
      pathTranslation: isSet(object.pathTranslation)
        ? backendRule_PathTranslationFromJSON(object.pathTranslation)
        : 0,
      jwtAudience: isSet(object.jwtAudience)
        ? String(object.jwtAudience)
        : undefined,
      disableAuth: isSet(object.disableAuth)
        ? Boolean(object.disableAuth)
        : undefined,
  ...
  toJSON(message: BackendRule): unknown {
    ...
    message.minDeadline !== undefined &&
      (obj.minDeadline = message.minDeadline);
    message.operationDeadline !== undefined &&
      (obj.operationDeadline = message.operationDeadline);
    message.pathTranslation !== undefined &&
      (obj.pathTranslation = backendRule_PathTranslationToJSON(
        message.pathTranslation
      ));
    message.jwtAudience !== undefined &&
      (obj.jwtAudience = message.jwtAudience);
    message.disableAuth !== undefined &&
      (obj.disableAuth = message.disableAuth);
    message.protocol !== undefined && (obj.protocol = message.protocol);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<BackendRule>, I>>(
    object: I
  ): BackendRule {
    const message = createBaseBackendRule();
