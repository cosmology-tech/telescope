...
export const MonitoredResourceDescriptor = {
  ...
  fromPartial<I extends Exact<DeepPartial<MonitoredResourceDescriptor>, I>>(
    object: I
  ): MonitoredResourceDescriptor {
    const message = createBaseMonitoredResourceDescriptor();
...
export const MonitoredResource = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          const entry2 = MonitoredResource_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<MonitoredResource>, I>>(
    object: I
  ): MonitoredResource {
    const message = createBaseMonitoredResource();
    message.type = object.type ?? "";
...
export const MonitoredResource_LabelsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<MonitoredResource_LabelsEntry>, I>>(
    object: I
  ): MonitoredResource_LabelsEntry {
    const message = createBaseMonitoredResource_LabelsEntry();
...
export const MonitoredResourceMetadata = {
  encode(
    ...
    if (message.systemLabels !== undefined) {
      Struct.encode(
        Struct.wrap(message.systemLabels),
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.systemLabels = Struct.unwrap(
            Struct.decode(reader, reader.uint32())
          );
          break;
        case 2:
          const entry2 = MonitoredResourceMetadata_UserLabelsEntry.decode(
            reader,
            reader.uint32()
          );
          if (entry2.value !== undefined) {
  ...
  fromJSON(object: any): MonitoredResourceMetadata {
    return {
      ...
      userLabels: isObject(object.userLabels)
        ? Object.entries(object.userLabels).reduce<{ [key: string]: string }>(
            (acc, [key, value]) => {
              acc[key] = String(value);
              return acc;
            },
  ...
  toJSON(message: MonitoredResourceMetadata): unknown {
    const obj: any = {};
    message.systemLabels !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<MonitoredResourceMetadata>, I>>(
    object: I
  ): MonitoredResourceMetadata {
    const message = createBaseMonitoredResourceMetadata();
...
export const MonitoredResourceMetadata_UserLabelsEntry = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<MonitoredResourceMetadata_UserLabelsEntry>, I>
  >(object: I): MonitoredResourceMetadata_UserLabelsEntry {
    const message = createBaseMonitoredResourceMetadata_UserLabelsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
