...
export const Distribution = {
  encode(
    ...
    if (message.range !== undefined) {
      Distribution_Range.encode(
        message.range,
        writer.uint32(34).fork()
      ).ldelim();
    }
    if (message.bucketOptions !== undefined) {
      Distribution_BucketOptions.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 6:
          message.bucketOptions = Distribution_BucketOptions.decode(
            reader,
            reader.uint32()
          );
          break;
        ...
        case 10:
          message.exemplars.push(
            Distribution_Exemplar.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  fromJSON(object: any): Distribution {
    return {
      ...
      sumOfSquaredDeviation: isSet(object.sumOfSquaredDeviation)
        ? Number(object.sumOfSquaredDeviation)
        : 0,
      range: isSet(object.range)
        ? Distribution_Range.fromJSON(object.range)
        : undefined,
      ...
      bucketCounts: Array.isArray(object?.bucketCounts)
        ? object.bucketCounts.map((e: any) => Long.fromString(e))
        : [],
  ...
  toJSON(message: Distribution): unknown {
    ...
    message.sumOfSquaredDeviation !== undefined &&
      (obj.sumOfSquaredDeviation = message.sumOfSquaredDeviation);
    message.range !== undefined &&
      (obj.range = message.range
        ? Distribution_Range.toJSON(message.range)
        : undefined);
    message.bucketOptions !== undefined &&
      (obj.bucketOptions = message.bucketOptions
        ? Distribution_BucketOptions.toJSON(message.bucketOptions)
        : undefined);
    ...
    if (message.exemplars) {
      obj.exemplars = message.exemplars.map((e) =>
        e ? Distribution_Exemplar.toJSON(e) : undefined
      );
    } else {
      obj.exemplars = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Distribution>, I>>(
    ...
    message.range =
      object.range !== undefined && object.range !== null
        ...
        : undefined;
    message.bucketOptions =
      object.bucketOptions !== undefined && object.bucketOptions !== null
        ? Distribution_BucketOptions.fromPartial(object.bucketOptions)
        : undefined;
    message.bucketCounts =
      object.bucketCounts?.map((e) => Long.fromValue(e)) || [];
    message.exemplars =
      object.exemplars?.map((e) => Distribution_Exemplar.fromPartial(e)) || [];
    return message;
  },
};
...
export const Distribution_Range = {
  ...
  fromPartial<I extends Exact<DeepPartial<Distribution_Range>, I>>(
    object: I
  ): Distribution_Range {
    const message = createBaseDistribution_Range();
...
export const Distribution_BucketOptions = {
  encode(
    ...
    if (message.linearBuckets !== undefined) {
      Distribution_BucketOptions_Linear.encode(
        message.linearBuckets,
        writer.uint32(10).fork()
      ).ldelim();
    }
    if (message.exponentialBuckets !== undefined) {
      Distribution_BucketOptions_Exponential.encode(
        message.exponentialBuckets,
        writer.uint32(18).fork()
      ).ldelim();
    }
    if (message.explicitBuckets !== undefined) {
      Distribution_BucketOptions_Explicit.encode(
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.linearBuckets = Distribution_BucketOptions_Linear.decode(
            reader,
            reader.uint32()
          );
          break;
        case 2:
          message.exponentialBuckets =
            Distribution_BucketOptions_Exponential.decode(
              reader,
              reader.uint32()
            );
          break;
        case 3:
          message.explicitBuckets = Distribution_BucketOptions_Explicit.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: Distribution_BucketOptions): unknown {
    const obj: any = {};
    message.linearBuckets !== undefined &&
      (obj.linearBuckets = message.linearBuckets
        ? Distribution_BucketOptions_Linear.toJSON(message.linearBuckets)
        : undefined);
    message.exponentialBuckets !== undefined &&
      (obj.exponentialBuckets = message.exponentialBuckets
        ? Distribution_BucketOptions_Exponential.toJSON(
            message.exponentialBuckets
          )
        : undefined);
    message.explicitBuckets !== undefined &&
      (obj.explicitBuckets = message.explicitBuckets
        ? Distribution_BucketOptions_Explicit.toJSON(message.explicitBuckets)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Distribution_BucketOptions>, I>>(
    object: I
  ): Distribution_BucketOptions {
    const message = createBaseDistribution_BucketOptions();
    message.linearBuckets =
      object.linearBuckets !== undefined && object.linearBuckets !== null
        ? Distribution_BucketOptions_Linear.fromPartial(object.linearBuckets)
        : undefined;
    message.exponentialBuckets =
      object.exponentialBuckets !== undefined &&
      object.exponentialBuckets !== null
        ? Distribution_BucketOptions_Exponential.fromPartial(
            object.exponentialBuckets
          )
        : undefined;
    message.explicitBuckets =
      object.explicitBuckets !== undefined && object.explicitBuckets !== null
        ? Distribution_BucketOptions_Explicit.fromPartial(
...
export const Distribution_BucketOptions_Linear = {
  ...
  toJSON(message: Distribution_BucketOptions_Linear): unknown {
    const obj: any = {};
    message.numFiniteBuckets !== undefined &&
  ...
  fromPartial<
    I extends Exact<DeepPartial<Distribution_BucketOptions_Linear>, I>
  >(object: I): Distribution_BucketOptions_Linear {
    const message = createBaseDistribution_BucketOptions_Linear();
...
export const Distribution_BucketOptions_Exponential = {
  ...
  fromJSON(object: any): Distribution_BucketOptions_Exponential {
    return {
      numFiniteBuckets: isSet(object.numFiniteBuckets)
        ? Number(object.numFiniteBuckets)
        : 0,
      growthFactor: isSet(object.growthFactor)
        ? Number(object.growthFactor)
        : 0,
  ...
  toJSON(message: Distribution_BucketOptions_Exponential): unknown {
    ...
    message.numFiniteBuckets !== undefined &&
      (obj.numFiniteBuckets = Math.round(message.numFiniteBuckets));
    message.growthFactor !== undefined &&
  ...
  fromPartial<
    I extends Exact<DeepPartial<Distribution_BucketOptions_Exponential>, I>
  >(object: I): Distribution_BucketOptions_Exponential {
    const message = createBaseDistribution_BucketOptions_Exponential();
    message.numFiniteBuckets = object.numFiniteBuckets ?? 0;
...
export const Distribution_BucketOptions_Explicit = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<Distribution_BucketOptions_Explicit>, I>
  >(object: I): Distribution_BucketOptions_Explicit {
    const message = createBaseDistribution_BucketOptions_Explicit();
...
export const Distribution_Exemplar = {
  ...
  fromPartial<I extends Exact<DeepPartial<Distribution_Exemplar>, I>>(
    object: I
  ): Distribution_Exemplar {
    const message = createBaseDistribution_Exemplar();
