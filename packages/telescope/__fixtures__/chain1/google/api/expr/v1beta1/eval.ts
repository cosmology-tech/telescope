...
export const EvalState = {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.results.push(
            EvalState_Result.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  fromJSON(object: any): EvalState {
    return {
      values: Array.isArray(object?.values)
        ? object.values.map((e: any) => ExprValue.fromJSON(e))
        : [],
  ...
  toJSON(message: EvalState): unknown {
    ...
    if (message.values) {
      obj.values = message.values.map((e) =>
        e ? ExprValue.toJSON(e) : undefined
      );
    } else {
      obj.values = [];
    }
    if (message.results) {
      obj.results = message.results.map((e) =>
        e ? EvalState_Result.toJSON(e) : undefined
      );
    } else {
      obj.results = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EvalState>, I>>(
    object: I
  ): EvalState {
    const message = createBaseEvalState();
    message.values = object.values?.map((e) => ExprValue.fromPartial(e)) || [];
    message.results =
      object.results?.map((e) => EvalState_Result.fromPartial(e)) || [];
    return message;
  },
};
...
export const EvalState_Result = {
  ...
  toJSON(message: EvalState_Result): unknown {
    ...
    message.expr !== undefined &&
      (obj.expr = message.expr ? IdRef.toJSON(message.expr) : undefined);
    message.value !== undefined && (obj.value = Math.round(message.value));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<EvalState_Result>, I>>(
    object: I
  ): EvalState_Result {
    const message = createBaseEvalState_Result();
    message.expr =
      object.expr !== undefined && object.expr !== null
        ? IdRef.fromPartial(object.expr)
        : undefined;
...
export const ExprValue = {
  ...
  fromJSON(object: any): ExprValue {
    return {
      ...
      unknown: isSet(object.unknown)
        ? UnknownSet.fromJSON(object.unknown)
        : undefined,
    };
  },
  ...
  toJSON(message: ExprValue): unknown {
    ...
    message.error !== undefined &&
      (obj.error = message.error ? ErrorSet.toJSON(message.error) : undefined);
    message.unknown !== undefined &&
      (obj.unknown = message.unknown
        ? UnknownSet.toJSON(message.unknown)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<ExprValue>, I>>(
    object: I
  ): ExprValue {
    const message = createBaseExprValue();
    message.value =
    ...
    message.error =
      object.error !== undefined && object.error !== null
        ...
        : undefined;
    message.unknown =
      object.unknown !== undefined && object.unknown !== null
  ...
  fromJSON(object: any): ErrorSet {
    return {
      errors: Array.isArray(object?.errors)
        ? object.errors.map((e: any) => Status.fromJSON(e))
        : [],
    };
  },
...
export const UnknownSet = {
  ...
  fromJSON(object: any): UnknownSet {
    return {
      exprs: Array.isArray(object?.exprs)
        ? object.exprs.map((e: any) => IdRef.fromJSON(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<UnknownSet>, I>>(
    object: I
  ): UnknownSet {
    const message = createBaseUnknownSet();
