...
export const Decl = {
  ...
  fromJSON(object: any): Decl {
    return {
      ...
      function: isSet(object.function)
        ? FunctionDecl.fromJSON(object.function)
        : undefined,
    };
  },
  ...
  toJSON(message: Decl): unknown {
    ...
    message.ident !== undefined &&
      (obj.ident = message.ident ? IdentDecl.toJSON(message.ident) : undefined);
    message.function !== undefined &&
      (obj.function = message.function
        ? FunctionDecl.toJSON(message.function)
        : undefined);
    return obj;
  },
...
export const DeclType = {
  ...
  toJSON(message: DeclType): unknown {
    ...
    if (message.typeParams) {
      obj.typeParams = message.typeParams.map((e) =>
        e ? DeclType.toJSON(e) : undefined
      );
    } else {
      obj.typeParams = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<DeclType>, I>>(object: I): DeclType {
    ...
    message.typeParams =
      object.typeParams?.map((e) => DeclType.fromPartial(e)) || [];
    return message;
  },
};
...
export const IdentDecl = {
  ...
  toJSON(message: IdentDecl): unknown {
    ...
    message.type !== undefined &&
      (obj.type = message.type ? DeclType.toJSON(message.type) : undefined);
    message.value !== undefined &&
      (obj.value = message.value ? Expr.toJSON(message.value) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<IdentDecl>, I>>(
    object: I
  ): IdentDecl {
    const message = createBaseIdentDecl();
    message.type =
      object.type !== undefined && object.type !== null
        ? DeclType.fromPartial(object.type)
        : undefined;
    message.value =
  ...
  fromJSON(object: any): FunctionDecl {
    return {
      ...
      returnType: isSet(object.returnType)
        ? DeclType.fromJSON(object.returnType)
        : undefined,
      receiverFunction: isSet(object.receiverFunction)
        ? Boolean(object.receiverFunction)
        : false,
    };
  },
  ...
  toJSON(message: FunctionDecl): unknown {
    ...
    message.returnType !== undefined &&
      (obj.returnType = message.returnType
        ...
        : undefined);
    message.receiverFunction !== undefined &&
      (obj.receiverFunction = message.receiverFunction);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<FunctionDecl>, I>>(
    object: I
  ): FunctionDecl {
    const message = createBaseFunctionDecl();
