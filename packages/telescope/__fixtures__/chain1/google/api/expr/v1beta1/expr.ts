...
export const Expr = {
  ...
  toJSON(message: Expr): unknown {
    ...
    message.literalExpr !== undefined &&
      (obj.literalExpr = message.literalExpr
  ...
  fromPartial<I extends Exact<DeepPartial<Expr>, I>>(object: I): Expr {
    ...
    message.literalExpr =
      object.literalExpr !== undefined && object.literalExpr !== null
        ? Literal.fromPartial(object.literalExpr)
        : undefined;
    message.identExpr =
