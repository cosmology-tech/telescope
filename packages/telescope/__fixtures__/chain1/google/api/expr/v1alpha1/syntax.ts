...
export const ParsedExpr = {
  ...
  fromPartial<I extends Exact<DeepPartial<ParsedExpr>, I>>(
    object: I
  ): ParsedExpr {
    const message = createBaseParsedExpr();
    message.expr =
      object.expr !== undefined && object.expr !== null
        ? Expr.fromPartial(object.expr)
        : undefined;
    message.sourceInfo =
...
export const Expr = {
  ...
  fromJSON(object: any): Expr {
    return {
      ...
      constExpr: isSet(object.constExpr)
        ? Constant.fromJSON(object.constExpr)
        : undefined,
      identExpr: isSet(object.identExpr)
        ? Expr_Ident.fromJSON(object.identExpr)
        : undefined,
      selectExpr: isSet(object.selectExpr)
        ? Expr_Select.fromJSON(object.selectExpr)
        : undefined,
      callExpr: isSet(object.callExpr)
        ? Expr_Call.fromJSON(object.callExpr)
        : undefined,
      listExpr: isSet(object.listExpr)
        ? Expr_CreateList.fromJSON(object.listExpr)
        : undefined,
      structExpr: isSet(object.structExpr)
        ? Expr_CreateStruct.fromJSON(object.structExpr)
        : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<Expr>, I>>(object: I): Expr {
    ...
    message.id =
      object.id !== undefined && object.id !== null
        ...
        : Long.ZERO;
    message.constExpr =
      object.constExpr !== undefined && object.constExpr !== null
        ? Constant.fromPartial(object.constExpr)
        : undefined;
    message.identExpr =
      object.identExpr !== undefined && object.identExpr !== null
        ? Expr_Ident.fromPartial(object.identExpr)
        : undefined;
    message.selectExpr =
      object.selectExpr !== undefined && object.selectExpr !== null
        ? Expr_Select.fromPartial(object.selectExpr)
        : undefined;
    message.callExpr =
      object.callExpr !== undefined && object.callExpr !== null
        ? Expr_Call.fromPartial(object.callExpr)
        : undefined;
    message.listExpr =
      object.listExpr !== undefined && object.listExpr !== null
        ? Expr_CreateList.fromPartial(object.listExpr)
        : undefined;
    message.structExpr =
      object.structExpr !== undefined && object.structExpr !== null
...
export const Expr_Ident = {
  ...
  fromPartial<I extends Exact<DeepPartial<Expr_Ident>, I>>(
    object: I
  ): Expr_Ident {
    const message = createBaseExpr_Ident();
...
export const Expr_Select = {
  ...
  fromPartial<I extends Exact<DeepPartial<Expr_Select>, I>>(
    object: I
  ): Expr_Select {
    const message = createBaseExpr_Select();
    message.operand =
      object.operand !== undefined && object.operand !== null
...
export const Expr_Call = {
  ...
  fromPartial<I extends Exact<DeepPartial<Expr_Call>, I>>(
    object: I
  ): Expr_Call {
    const message = createBaseExpr_Call();
    message.target =
...
export const Expr_CreateList = {
  ...
  fromPartial<I extends Exact<DeepPartial<Expr_CreateList>, I>>(
    object: I
  ): Expr_CreateList {
    const message = createBaseExpr_CreateList();
...
export const Expr_CreateStruct = {
  ...
  fromPartial<I extends Exact<DeepPartial<Expr_CreateStruct>, I>>(
    object: I
  ): Expr_CreateStruct {
    const message = createBaseExpr_CreateStruct();
    message.messageName = object.messageName ?? "";
    message.entries =
      object.entries?.map((e) => Expr_CreateStruct_Entry.fromPartial(e)) || [];
    return message;
  },
};
...
export const Expr_CreateStruct_Entry = {
  ...
  fromPartial<I extends Exact<DeepPartial<Expr_CreateStruct_Entry>, I>>(
    object: I
  ): Expr_CreateStruct_Entry {
    const message = createBaseExpr_CreateStruct_Entry();
    message.id =
    ...
    message.mapKey =
      object.mapKey !== undefined && object.mapKey !== null
        ? Expr.fromPartial(object.mapKey)
        : undefined;
    message.value =
      object.value !== undefined && object.value !== null
        ? Expr.fromPartial(object.value)
        : undefined;
    return message;
  },
};
...
export const Expr_Comprehension = {
  ...
  fromPartial<I extends Exact<DeepPartial<Expr_Comprehension>, I>>(
    object: I
  ): Expr_Comprehension {
    const message = createBaseExpr_Comprehension();
    message.iterVar = object.iterVar ?? "";
    message.iterRange =
      object.iterRange !== undefined && object.iterRange !== null
        ? Expr.fromPartial(object.iterRange)
        : undefined;
    message.accuVar = object.accuVar ?? "";
    message.accuInit =
      object.accuInit !== undefined && object.accuInit !== null
        ? Expr.fromPartial(object.accuInit)
        : undefined;
    message.loopCondition =
      object.loopCondition !== undefined && object.loopCondition !== null
        ? Expr.fromPartial(object.loopCondition)
        : undefined;
    message.loopStep =
      object.loopStep !== undefined && object.loopStep !== null
...
export const Constant = {
  ...
  fromJSON(object: any): Constant {
    return {
      ...
      int64Value: isSet(object.int64Value)
        ? Long.fromString(object.int64Value)
        : undefined,
      uint64Value: isSet(object.uint64Value)
        ? Long.fromString(object.uint64Value)
        : undefined,
  ...
  toJSON(message: Constant): unknown {
    ...
    message.int64Value !== undefined &&
      (obj.int64Value = (message.int64Value || undefined).toString());
    message.uint64Value !== undefined &&
      (obj.uint64Value = (message.uint64Value || undefined).toString());
  ...
  fromPartial<I extends Exact<DeepPartial<Constant>, I>>(object: I): Constant {
    ...
    message.int64Value =
      object.int64Value !== undefined && object.int64Value !== null
        ? Long.fromValue(object.int64Value)
        : undefined;
    message.uint64Value =
      object.uint64Value !== undefined && object.uint64Value !== null
    ...
    message.durationValue =
      object.durationValue !== undefined && object.durationValue !== null
  ...
  fromJSON(object: any): SourceInfo {
    return {
      ...
      positions: isObject(object.positions)
        ? Object.entries(object.positions).reduce<{ [key: Long]: number }>(
            (acc, [key, value]) => {
      ...
      macroCalls: isObject(object.macroCalls)
        ? Object.entries(object.macroCalls).reduce<{ [key: Long]: Expr }>(
            (acc, [key, value]) => {
...
export const SourceInfo_MacroCallsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<SourceInfo_MacroCallsEntry>, I>>(
    object: I
  ): SourceInfo_MacroCallsEntry {
    const message = createBaseSourceInfo_MacroCallsEntry();
    message.key =
