...
import {
  CheckedExpr,
  Decl,
} from "../../../../../google/api/expr/v1alpha1/checked";
...
export function issueDetails_SeverityFromJSON(
  object: any
...
export function issueDetails_SeverityToJSON(
  object: IssueDetails_Severity
): string {
  switch (object) {
...
export const ParseRequest = {
  ...
  toJSON(message: ParseRequest): unknown {
    ...
    message.disableMacros !== undefined &&
...
export const ParseResponse = {
  ...
  fromJSON(object: any): ParseResponse {
    return {
      ...
      issues: Array.isArray(object?.issues)
        ? object.issues.map((e: any) => Status.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: ParseResponse): unknown {
    ...
    message.parsedExpr !== undefined &&
      (obj.parsedExpr = message.parsedExpr
        ? ParsedExpr.toJSON(message.parsedExpr)
        : undefined);
    if (message.issues) {
  ...
  fromPartial<I extends Exact<DeepPartial<ParseResponse>, I>>(
    ...
    const message = createBaseParseResponse();
    message.parsedExpr =
      object.parsedExpr !== undefined && object.parsedExpr !== null
  ...
  fromJSON(object: any): CheckRequest {
    return {
      parsedExpr: isSet(object.parsedExpr)
        ? ParsedExpr.fromJSON(object.parsedExpr)
        : undefined,
      typeEnv: Array.isArray(object?.typeEnv)
  ...
  toJSON(message: CheckRequest): unknown {
    ...
    message.parsedExpr !== undefined &&
      (obj.parsedExpr = message.parsedExpr
        ...
        : undefined);
    if (message.typeEnv) {
      obj.typeEnv = message.typeEnv.map((e) =>
        e ? Decl.toJSON(e) : undefined
      );
    } else {
      obj.typeEnv = [];
    }
...
export const CheckResponse = {
  ...
  toJSON(message: CheckResponse): unknown {
    const obj: any = {};
    message.checkedExpr !== undefined &&
      (obj.checkedExpr = message.checkedExpr
        ? CheckedExpr.toJSON(message.checkedExpr)
        : undefined);
    if (message.issues) {
      obj.issues = message.issues.map((e) =>
        e ? Status.toJSON(e) : undefined
  ...
  fromPartial<I extends Exact<DeepPartial<CheckResponse>, I>>(
    ...
    const message = createBaseCheckResponse();
    message.checkedExpr =
      object.checkedExpr !== undefined && object.checkedExpr !== null
...
export const EvalRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = EvalRequest_BindingsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): EvalRequest {
    return {
      ...
      bindings: isObject(object.bindings)
        ? Object.entries(object.bindings).reduce<{ [key: string]: ExprValue }>(
            (acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<EvalRequest>, I>>(
    object: I
  ): EvalRequest {
    const message = createBaseEvalRequest();
    message.parsedExpr =
...
export const EvalRequest_BindingsEntry = {
  encode(
    message: EvalRequest_BindingsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
  ...
  toJSON(message: EvalRequest_BindingsEntry): unknown {
    ...
    message.value !== undefined &&
      (obj.value = message.value ? ExprValue.toJSON(message.value) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<EvalRequest_BindingsEntry>, I>>(
    object: I
  ): EvalRequest_BindingsEntry {
    const message = createBaseEvalRequest_BindingsEntry();
...
export const EvalResponse = {
  ...
  fromJSON(object: any): EvalResponse {
    return {
      result: isSet(object.result)
        ? ExprValue.fromJSON(object.result)
        : undefined,
      issues: Array.isArray(object?.issues)
        ? object.issues.map((e: any) => Status.fromJSON(e))
        : [],
  ...
  toJSON(message: EvalResponse): unknown {
    ...
    message.result !== undefined &&
      (obj.result = message.result
        ? ExprValue.toJSON(message.result)
        : undefined);
    if (message.issues) {
      obj.issues = message.issues.map((e) =>
        e ? Status.toJSON(e) : undefined
  ...
  fromPartial<I extends Exact<DeepPartial<EvalResponse>, I>>(
    object: I
  ): EvalResponse {
    const message = createBaseEvalResponse();
    message.result =
  ...
  fromJSON(object: any): IssueDetails {
    return {
      ...
      position: isSet(object.position)
        ? SourcePosition.fromJSON(object.position)
        : undefined,
  ...
  toJSON(message: IssueDetails): unknown {
    ...
    message.position !== undefined &&
      (obj.position = message.position
        ? SourcePosition.toJSON(message.position)
        : undefined);
    message.id !== undefined && (obj.id = (message.id || Long.ZERO).toString());
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<IssueDetails>, I>>(
    object: I
  ): IssueDetails {
    const message = createBaseIssueDetails();
