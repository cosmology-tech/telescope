...
export const Authentication = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Authentication {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 3:
          message.rules.push(
            AuthenticationRule.decode(reader, reader.uint32())
          );
          break;
        case 4:
  ...
  toJSON(message: Authentication): unknown {
    ...
    if (message.rules) {
      obj.rules = message.rules.map((e) =>
        e ? AuthenticationRule.toJSON(e) : undefined
      );
    } else {
      obj.rules = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Authentication>, I>>(
    object: I
  ): Authentication {
    const message = createBaseAuthentication();
    message.rules =
      object.rules?.map((e) => AuthenticationRule.fromPartial(e)) || [];
    message.providers =
...
export const AuthenticationRule = {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          message.requirements.push(
            AuthRequirement.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): AuthenticationRule {
    return {
      ...
      allowWithoutCredential: isSet(object.allowWithoutCredential)
        ? Boolean(object.allowWithoutCredential)
        : false,
  ...
  toJSON(message: AuthenticationRule): unknown {
    ...
    message.oauth !== undefined &&
      (obj.oauth = message.oauth
        ? OAuthRequirements.toJSON(message.oauth)
        : undefined);
    message.allowWithoutCredential !== undefined &&
      (obj.allowWithoutCredential = message.allowWithoutCredential);
    if (message.requirements) {
      obj.requirements = message.requirements.map((e) =>
        e ? AuthRequirement.toJSON(e) : undefined
      );
    } else {
      obj.requirements = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<AuthenticationRule>, I>>(
    object: I
  ): AuthenticationRule {
    const message = createBaseAuthenticationRule();
    ...
    message.requirements =
      object.requirements?.map((e) => AuthRequirement.fromPartial(e)) || [];
    return message;
  },
};
...
export const JwtLocation = {
  ...
  toJSON(message: JwtLocation): unknown {
    ...
    message.valuePrefix !== undefined &&
      (obj.valuePrefix = message.valuePrefix);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<JwtLocation>, I>>(
    object: I
  ): JwtLocation {
    const message = createBaseJwtLocation();
...
export const AuthProvider = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.jwtLocations.push(
            JwtLocation.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): AuthProvider {
    return {
      ...
      authorizationUrl: isSet(object.authorizationUrl)
        ...
        : "",
      jwtLocations: Array.isArray(object?.jwtLocations)
  ...
  toJSON(message: AuthProvider): unknown {
    ...
    if (message.jwtLocations) {
      obj.jwtLocations = message.jwtLocations.map((e) =>
        e ? JwtLocation.toJSON(e) : undefined
      );
    } else {
      obj.jwtLocations = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<AuthProvider>, I>>(
    object: I
  ): AuthProvider {
    const message = createBaseAuthProvider();
    ...
    message.jwtLocations =
      object.jwtLocations?.map((e) => JwtLocation.fromPartial(e)) || [];
    return message;
  },
};
...
export const OAuthRequirements = {
  ...
  toJSON(message: OAuthRequirements): unknown {
    const obj: any = {};
    message.canonicalScopes !== undefined &&
      (obj.canonicalScopes = message.canonicalScopes);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<OAuthRequirements>, I>>(
    object: I
  ): OAuthRequirements {
    const message = createBaseOAuthRequirements();
...
export const AuthRequirement = {
  ...
  fromPartial<I extends Exact<DeepPartial<AuthRequirement>, I>>(
    object: I
  ): AuthRequirement {
    const message = createBaseAuthRequirement();
