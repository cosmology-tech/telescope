...
export const Service = {
      ...
      switch (tag >>> 3) {
        ...
        case 24:
          message.metrics.push(
            MetricDescriptor.decode(reader, reader.uint32())
          );
          break;
        case 25:
        ...
        case 28:
          ...
          break;
        case 29:
          message.systemParameters = SystemParameters.decode(
            reader,
            reader.uint32()
          );
          break;
        case 37:
          ...
          break;
        case 20:
          message.configVersion = UInt32Value.decode(
            reader,
            reader.uint32()
          ).value;
          break;
  ...
  fromJSON(object: any): Service {
    return {
      ...
      control: isSet(object.control)
        ? Control.fromJSON(object.control)
        : undefined,
      logs: Array.isArray(object?.logs)
        ? object.logs.map((e: any) => LogDescriptor.fromJSON(e))
        : [],
  ...
  toJSON(message: Service): unknown {
    ...
    message.backend !== undefined &&
      (obj.backend = message.backend
        ? Backend.toJSON(message.backend)
        : undefined);
    message.http !== undefined &&
      (obj.http = message.http ? Http.toJSON(message.http) : undefined);
    ...
    message.control !== undefined &&
      (obj.control = message.control
        ? Control.toJSON(message.control)
        : undefined);
    if (message.logs) {
      obj.logs = message.logs.map((e) =>
        e ? LogDescriptor.toJSON(e) : undefined
      );
    } else {
      obj.logs = [];
    }
    if (message.metrics) {
      obj.metrics = message.metrics.map((e) =>
        e ? MetricDescriptor.toJSON(e) : undefined
      );
    } else {
      obj.metrics = [];
    }
    ...
    message.billing !== undefined &&
      (obj.billing = message.billing
        ? Billing.toJSON(message.billing)
        : undefined);
    ...
    message.systemParameters !== undefined &&
      (obj.systemParameters = message.systemParameters
        ? SystemParameters.toJSON(message.systemParameters)
        : undefined);
    message.sourceInfo !== undefined &&
      (obj.sourceInfo = message.sourceInfo
        ? SourceInfo.toJSON(message.sourceInfo)
        : undefined);
    message.configVersion !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<Service>, I>>(object: I): Service {
    ...
    message.metrics =
      object.metrics?.map((e) => MetricDescriptor.fromPartial(e)) || [];
    ...
    message.monitoring =
      object.monitoring !== undefined && object.monitoring !== null
        ...
        : undefined;
    message.systemParameters =
      object.systemParameters !== undefined && object.systemParameters !== null
