  ...
  fromJSON(object: any): CheckRequest {
    return {
      ...
      attributes: isSet(object.attributes)
        ? AttributeContext.fromJSON(object.attributes)
        : undefined,
  ...
  toJSON(message: CheckRequest): unknown {
    ...
    message.attributes !== undefined &&
      (obj.attributes = message.attributes
        ? AttributeContext.toJSON(message.attributes)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<CheckRequest>, I>>(
    ...
    message.attributes =
      object.attributes !== undefined && object.attributes !== null
        ...
        : undefined;
    message.resources =
      object.resources?.map((e) => ResourceInfo.fromPartial(e)) || [];
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          const entry2 = CheckResponse_HeadersEntry.decode(
            reader,
            reader.uint32()
          );
...
export const CheckResponse_HeadersEntry = {
  encode(
    message: CheckResponse_HeadersEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<CheckResponse_HeadersEntry>, I>>(
    object: I
  ): CheckResponse_HeadersEntry {
    const message = createBaseCheckResponse_HeadersEntry();
...
export const ReportRequest = {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          message.operations.push(
            AttributeContext.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message: ReportRequest): unknown {
    ...
    if (message.operations) {
      obj.operations = message.operations.map((e) =>
        e ? AttributeContext.toJSON(e) : undefined
      );
    } else {
      obj.operations = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ReportRequest>, I>>(
    ...
    message.serviceConfigId = object.serviceConfigId ?? "";
    message.operations =
      object.operations?.map((e) => AttributeContext.fromPartial(e)) || [];
    return message;
  },
};
