...
export function operation_ImportanceFromJSON(
  object: any
...
export function operation_ImportanceToJSON(
  object: Operation_Importance
): string {
  switch (object) {
...
export const Operation = {
  ...
  fromJSON(object: any): Operation {
    return {
      ...
      labels: isObject(object.labels)
        ...
        : {},
      metricValueSets: Array.isArray(object?.metricValueSets)
      ...
      logEntries: Array.isArray(object?.logEntries)
        ...
        : [],
      importance: isSet(object.importance)
        ? operation_ImportanceFromJSON(object.importance)
        : 0,
  ...
  toJSON(message: Operation): unknown {
    ...
    message.operationName !== undefined &&
    ...
    if (message.metricValueSets) {
      obj.metricValueSets = message.metricValueSets.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<Operation>, I>>(
    ...
    message.metricValueSets =
      object.metricValueSets?.map((e) => MetricValueSet.fromPartial(e)) || [];
    message.logEntries =
      object.logEntries?.map((e) => LogEntry.fromPartial(e)) || [];
...
export const Operation_LabelsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<Operation_LabelsEntry>, I>>(
    object: I
  ): Operation_LabelsEntry {
    const message = createBaseOperation_LabelsEntry();
