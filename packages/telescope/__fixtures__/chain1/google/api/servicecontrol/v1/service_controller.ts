...
export function checkResponse_ConsumerInfo_ConsumerTypeFromJSON(
  object: any
...
export function checkResponse_ConsumerInfo_ConsumerTypeToJSON(
  object: CheckResponse_ConsumerInfo_ConsumerType
): string {
  switch (object) {
  ...
  fromJSON(object: any): CheckRequest {
    return {
      ...
      operation: isSet(object.operation)
        ? Operation.fromJSON(object.operation)
        : undefined,
      serviceConfigId: isSet(object.serviceConfigId)
        ? String(object.serviceConfigId)
        : "",
    };
  },
  ...
  toJSON(message: CheckRequest): unknown {
    ...
    message.operation !== undefined &&
      (obj.operation = message.operation
        ...
        : undefined);
    message.serviceConfigId !== undefined &&
...
export const CheckResponse = {
  encode(
    ...
    if (message.checkInfo !== undefined) {
      CheckResponse_CheckInfo.encode(
        message.checkInfo,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          break;
        case 6:
          message.checkInfo = CheckResponse_CheckInfo.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): CheckResponse {
    return {
      ...
      checkErrors: Array.isArray(object?.checkErrors)
      ...
      serviceRolloutId: isSet(object.serviceRolloutId)
        ? String(object.serviceRolloutId)
        : "",
  ...
  toJSON(message: CheckResponse): unknown {
    ...
    if (message.checkErrors) {
      obj.checkErrors = message.checkErrors.map((e) =>
        e ? CheckError.toJSON(e) : undefined
      );
    } else {
      obj.checkErrors = [];
    }
    message.serviceConfigId !== undefined &&
      (obj.serviceConfigId = message.serviceConfigId);
    message.serviceRolloutId !== undefined &&
      (obj.serviceRolloutId = message.serviceRolloutId);
    message.checkInfo !== undefined &&
      (obj.checkInfo = message.checkInfo
        ? CheckResponse_CheckInfo.toJSON(message.checkInfo)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CheckResponse>, I>>(
    ...
    message.checkErrors =
      object.checkErrors?.map((e) => CheckError.fromPartial(e)) || [];
    message.serviceConfigId = object.serviceConfigId ?? "";
    message.serviceRolloutId = object.serviceRolloutId ?? "";
    message.checkInfo =
      object.checkInfo !== undefined && object.checkInfo !== null
...
function createBaseCheckResponse_CheckInfo(): CheckResponse_CheckInfo {
  return { unusedArguments: [], consumerInfo: undefined };
}

export const CheckResponse_CheckInfo = {
  encode(
    message: CheckResponse_CheckInfo,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    ...
    if (message.consumerInfo !== undefined) {
      CheckResponse_ConsumerInfo.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.consumerInfo = CheckResponse_ConsumerInfo.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): CheckResponse_CheckInfo {
    return {
      unusedArguments: Array.isArray(object?.unusedArguments)
        ? object.unusedArguments.map((e: any) => String(e))
        : [],
  ...
  toJSON(message: CheckResponse_CheckInfo): unknown {
    ...
    message.consumerInfo !== undefined &&
      (obj.consumerInfo = message.consumerInfo
        ? CheckResponse_ConsumerInfo.toJSON(message.consumerInfo)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CheckResponse_CheckInfo>, I>>(
    object: I
  ): CheckResponse_CheckInfo {
    const message = createBaseCheckResponse_CheckInfo();
    message.unusedArguments = object.unusedArguments?.map((e) => e) || [];
    message.consumerInfo =
      object.consumerInfo !== undefined && object.consumerInfo !== null
...
export const CheckResponse_ConsumerInfo = {
  encode(
    message: CheckResponse_ConsumerInfo,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
  ...
  fromJSON(object: any): CheckResponse_ConsumerInfo {
    return {
      projectNumber: isSet(object.projectNumber)
        ? Long.fromString(object.projectNumber)
        : Long.ZERO,
      type: isSet(object.type)
        ? checkResponse_ConsumerInfo_ConsumerTypeFromJSON(object.type)
        : 0,
      consumerNumber: isSet(object.consumerNumber)
        ? Long.fromString(object.consumerNumber)
        : Long.ZERO,
    };
  },
  ...
  toJSON(message: CheckResponse_ConsumerInfo): unknown {
    const obj: any = {};
    message.projectNumber !== undefined &&
    ...
    message.consumerNumber !== undefined &&
      (obj.consumerNumber = (message.consumerNumber || Long.ZERO).toString());
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CheckResponse_ConsumerInfo>, I>>(
    object: I
  ): CheckResponse_ConsumerInfo {
    const message = createBaseCheckResponse_ConsumerInfo();
    message.projectNumber =
      object.projectNumber !== undefined && object.projectNumber !== null
        ? Long.fromValue(object.projectNumber)
        : Long.ZERO;
    message.type = object.type ?? 0;
    message.consumerNumber =
      object.consumerNumber !== undefined && object.consumerNumber !== null
...
export const ReportResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ReportResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.reportErrors.push(
            ReportResponse_ReportError.decode(reader, reader.uint32())
          );
          break;
        case 2:
          message.serviceConfigId = reader.string();
  ...
  fromJSON(object: any): ReportResponse {
    return {
      reportErrors: Array.isArray(object?.reportErrors)
        ? object.reportErrors.map((e: any) =>
            ReportResponse_ReportError.fromJSON(e)
          )
        : [],
      serviceConfigId: isSet(object.serviceConfigId)
        ? String(object.serviceConfigId)
  ...
  toJSON(message: ReportResponse): unknown {
    ...
    if (message.reportErrors) {
      obj.reportErrors = message.reportErrors.map((e) =>
        e ? ReportResponse_ReportError.toJSON(e) : undefined
      );
    } else {
      obj.reportErrors = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ReportResponse>, I>>(
    object: I
  ): ReportResponse {
    const message = createBaseReportResponse();
    message.reportErrors =
      object.reportErrors?.map((e) =>
        ReportResponse_ReportError.fromPartial(e)
      ) || [];
    message.serviceConfigId = object.serviceConfigId ?? "";
    message.serviceRolloutId = object.serviceRolloutId ?? "";
    return message;
...
export const ReportResponse_ReportError = {
  encode(
    message: ReportResponse_ReportError,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.operationId !== "") {
      writer.uint32(10).string(message.operationId);
  ...
  fromPartial<I extends Exact<DeepPartial<ReportResponse_ReportError>, I>>(
    object: I
  ): ReportResponse_ReportError {
    const message = createBaseReportResponse_ReportError();
    message.operationId = object.operationId ?? "";
