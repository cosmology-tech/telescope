...
export function quotaOperation_QuotaModeFromJSON(
  object: any
...
export function quotaOperation_QuotaModeToJSON(
  object: QuotaOperation_QuotaMode
): string {
  switch (object) {
...
export const AllocateQuotaRequest = {
  encode(
    ...
    if (message.allocateOperation !== undefined) {
      QuotaOperation.encode(
        message.allocateOperation,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.allocateOperation = QuotaOperation.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: AllocateQuotaRequest): unknown {
    ...
    message.allocateOperation !== undefined &&
      (obj.allocateOperation = message.allocateOperation
        ? QuotaOperation.toJSON(message.allocateOperation)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<AllocateQuotaRequest>, I>>(
    object: I
  ): AllocateQuotaRequest {
    const message = createBaseAllocateQuotaRequest();
    message.serviceName = object.serviceName ?? "";
    message.allocateOperation =
      object.allocateOperation !== undefined &&
...
export const QuotaOperation = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          const entry4 = QuotaOperation_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
          ...
          break;
        case 5:
          message.quotaMetrics.push(
            MetricValueSet.decode(reader, reader.uint32())
          );
          break;
        case 6:
  ...
  fromJSON(object: any): QuotaOperation {
    return {
      ...
      labels: isObject(object.labels)
        ...
        : {},
      quotaMetrics: Array.isArray(object?.quotaMetrics)
        ? object.quotaMetrics.map((e: any) => MetricValueSet.fromJSON(e))
        : [],
      quotaMode: isSet(object.quotaMode)
        ? quotaOperation_QuotaModeFromJSON(object.quotaMode)
        : 0,
    };
  },
  ...
  toJSON(message: QuotaOperation): unknown {
    ...
    if (message.quotaMetrics) {
      obj.quotaMetrics = message.quotaMetrics.map((e) =>
        e ? MetricValueSet.toJSON(e) : undefined
      );
    } else {
      obj.quotaMetrics = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QuotaOperation>, I>>(
    object: I
  ): QuotaOperation {
    const message = createBaseQuotaOperation();
    ...
    message.quotaMetrics =
      object.quotaMetrics?.map((e) => MetricValueSet.fromPartial(e)) || [];
...
export const QuotaOperation_LabelsEntry = {
  encode(
    message: QuotaOperation_LabelsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<QuotaOperation_LabelsEntry>, I>>(
    object: I
  ): QuotaOperation_LabelsEntry {
    const message = createBaseQuotaOperation_LabelsEntry();
...
export const AllocateQuotaResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.allocateErrors.push(
            QuotaError.decode(reader, reader.uint32())
          );
          break;
        case 3:
          message.quotaMetrics.push(
  ...
  fromJSON(object: any): AllocateQuotaResponse {
    return {
      operationId: isSet(object.operationId) ? String(object.operationId) : "",
      allocateErrors: Array.isArray(object?.allocateErrors)
  ...
  toJSON(message: AllocateQuotaResponse): unknown {
    ...
    if (message.allocateErrors) {
      obj.allocateErrors = message.allocateErrors.map((e) =>
        e ? QuotaError.toJSON(e) : undefined
      );
    } else {
      obj.allocateErrors = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<AllocateQuotaResponse>, I>>(
    object: I
  ): AllocateQuotaResponse {
    const message = createBaseAllocateQuotaResponse();
    message.operationId = object.operationId ?? "";
    message.allocateErrors =
      object.allocateErrors?.map((e) => QuotaError.fromPartial(e)) || [];
    message.quotaMetrics =
      object.quotaMetrics?.map((e) => MetricValueSet.fromPartial(e)) || [];
    message.serviceConfigId = object.serviceConfigId ?? "";
    return message;
...
export const QuotaError = {
  ...
  fromPartial<I extends Exact<DeepPartial<QuotaError>, I>>(
    object: I
  ): QuotaError {
    const message = createBaseQuotaError();
...
export class QuotaControllerClientImpl implements QuotaController {
  ...
  AllocateQuota(request: AllocateQuotaRequest): Promise<AllocateQuotaResponse> {
    ...
    return promise.then((data) =>
      AllocateQuotaResponse.decode(new _m0.Reader(data))
    );
  }
}
