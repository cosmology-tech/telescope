...
export const Distribution = {
  encode(
    ...
    if (message.linearBuckets !== undefined) {
      Distribution_LinearBuckets.encode(
        message.linearBuckets,
        writer.uint32(58).fork()
      ).ldelim();
    }
    if (message.exponentialBuckets !== undefined) {
      Distribution_ExponentialBuckets.encode(
        message.exponentialBuckets,
        writer.uint32(66).fork()
      ).ldelim();
    }
    if (message.explicitBuckets !== undefined) {
      Distribution_ExplicitBuckets.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          message.linearBuckets = Distribution_LinearBuckets.decode(
            reader,
            reader.uint32()
          );
          break;
        case 8:
          message.exponentialBuckets = Distribution_ExponentialBuckets.decode(
            reader,
            reader.uint32()
          );
          break;
        case 9:
          message.explicitBuckets = Distribution_ExplicitBuckets.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: Distribution): unknown {
    ...
    message.linearBuckets !== undefined &&
      (obj.linearBuckets = message.linearBuckets
        ? Distribution_LinearBuckets.toJSON(message.linearBuckets)
        : undefined);
    message.exponentialBuckets !== undefined &&
      (obj.exponentialBuckets = message.exponentialBuckets
        ? Distribution_ExponentialBuckets.toJSON(message.exponentialBuckets)
        : undefined);
    message.explicitBuckets !== undefined &&
      (obj.explicitBuckets = message.explicitBuckets
        ? Distribution_ExplicitBuckets.toJSON(message.explicitBuckets)
        : undefined);
...
export const Distribution_LinearBuckets = {
  ...
  fromPartial<I extends Exact<DeepPartial<Distribution_LinearBuckets>, I>>(
    object: I
  ): Distribution_LinearBuckets {
    const message = createBaseDistribution_LinearBuckets();
...
export const Distribution_ExponentialBuckets = {
  ...
  fromPartial<I extends Exact<DeepPartial<Distribution_ExponentialBuckets>, I>>(
    object: I
  ): Distribution_ExponentialBuckets {
    const message = createBaseDistribution_ExponentialBuckets();
    message.numFiniteBuckets = object.numFiniteBuckets ?? 0;
...
export const Distribution_ExplicitBuckets = {
  ...
  fromPartial<I extends Exact<DeepPartial<Distribution_ExplicitBuckets>, I>>(
    object: I
  ): Distribution_ExplicitBuckets {
    const message = createBaseDistribution_ExplicitBuckets();
