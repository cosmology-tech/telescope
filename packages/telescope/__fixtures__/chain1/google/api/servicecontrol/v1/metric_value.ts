...
export const MetricValue = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MetricValue {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          const entry1 = MetricValue_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
        ...
        case 7:
          ...
          break;
        case 8:
          message.distributionValue = Distribution.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): MetricValue {
    return {
      ...
      distributionValue: isSet(object.distributionValue)
        ? Distribution.fromJSON(object.distributionValue)
        : undefined,
    };
  },
  ...
  toJSON(message: MetricValue): unknown {
    ...
    message.distributionValue !== undefined &&
      (obj.distributionValue = message.distributionValue
        ? Distribution.toJSON(message.distributionValue)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MetricValue>, I>>(
    object: I
  ): MetricValue {
    const message = createBaseMetricValue();
    ...
    message.distributionValue =
      object.distributionValue !== undefined &&
...
export const MetricValue_LabelsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<MetricValue_LabelsEntry>, I>>(
    object: I
  ): MetricValue_LabelsEntry {
    const message = createBaseMetricValue_LabelsEntry();
...
export const MetricValueSet = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.metricValues.push(
            MetricValue.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message: MetricValueSet): unknown {
    ...
    if (message.metricValues) {
      obj.metricValues = message.metricValues.map((e) =>
        e ? MetricValue.toJSON(e) : undefined
      );
    } else {
      obj.metricValues = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<MetricValueSet>, I>>(
    object: I
  ): MetricValueSet {
    const message = createBaseMetricValueSet();
    message.metricName = object.metricName ?? "";
    message.metricValues =
      object.metricValues?.map((e) => MetricValue.fromPartial(e)) || [];
    return message;
  },
};
