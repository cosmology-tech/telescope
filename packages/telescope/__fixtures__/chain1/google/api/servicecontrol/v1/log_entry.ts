...
export interface LogEntry {
   ...
   */
  structPayload: { [key: string]: any } | undefined;
  /**
...
export const LogEntry = {
  encode(
    ...
    if (message.structPayload !== undefined) {
      Struct.encode(
        Struct.wrap(message.structPayload),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 6:
          message.structPayload = Struct.unwrap(
  ...
  fromJSON(object: any): LogEntry {
    return {
      ...
      textPayload: isSet(object.textPayload)
        ...
        : undefined,
      structPayload: isObject(object.structPayload)
        ? object.structPayload
        : undefined,
  ...
  toJSON(message: LogEntry): unknown {
    ...
    message.structPayload !== undefined &&
