...
export function operationMetadata_StatusFromJSON(
  object: any
...
export function operationMetadata_StatusToJSON(
  object: OperationMetadata_Status
): string {
  switch (object) {
...
export function rollout_RolloutStatusFromJSON(
  object: any
...
export function rollout_RolloutStatusToJSON(
  object: Rollout_RolloutStatus
): string {
  switch (object) {
...
export const ManagedService = {
  ...
  fromPartial<I extends Exact<DeepPartial<ManagedService>, I>>(
    object: I
  ): ManagedService {
    const message = createBaseManagedService();
...
export const OperationMetadata = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OperationMetadata {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.steps.push(
            OperationMetadata_Step.decode(reader, reader.uint32())
          );
          break;
        case 3:
  ...
  toJSON(message: OperationMetadata): unknown {
    ...
    if (message.steps) {
      obj.steps = message.steps.map((e) =>
        e ? OperationMetadata_Step.toJSON(e) : undefined
      );
    } else {
      obj.steps = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<OperationMetadata>, I>>(
    ...
    message.steps =
      object.steps?.map((e) => OperationMetadata_Step.fromPartial(e)) || [];
...
export const OperationMetadata_Step = {
  ...
  fromPartial<I extends Exact<DeepPartial<OperationMetadata_Step>, I>>(
    object: I
  ): OperationMetadata_Step {
    const message = createBaseOperationMetadata_Step();
...
export const ConfigSource = {
  ...
  toJSON(message: ConfigSource): unknown {
    ...
    if (message.files) {
      obj.files = message.files.map((e) =>
        e ? ConfigFile.toJSON(e) : undefined
      );
    } else {
      obj.files = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ConfigSource>, I>>(
    object: I
  ): ConfigSource {
    const message = createBaseConfigSource();
...
export const ConfigFile = {
  ...
  fromJSON(object: any): ConfigFile {
    return {
      ...
      fileType: isSet(object.fileType)
        ? configFile_FileTypeFromJSON(object.fileType)
        : 0,
    };
  },
  ...
  toJSON(message: ConfigFile): unknown {
    ...
    message.fileContents !== undefined &&
      (obj.fileContents = base64FromBytes(
        message.fileContents !== undefined
  ...
  fromPartial<I extends Exact<DeepPartial<ConfigFile>, I>>(
    object: I
  ): ConfigFile {
    const message = createBaseConfigFile();
...
export const ConfigRef = {
  ...
  fromPartial<I extends Exact<DeepPartial<ConfigRef>, I>>(
    object: I
  ): ConfigRef {
    const message = createBaseConfigRef();
...
export const ChangeReport = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChangeReport {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.configChanges.push(
            ConfigChange.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message: ChangeReport): unknown {
    ...
    if (message.configChanges) {
      obj.configChanges = message.configChanges.map((e) =>
        e ? ConfigChange.toJSON(e) : undefined
      );
    } else {
      obj.configChanges = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ChangeReport>, I>>(
    object: I
  ): ChangeReport {
    const message = createBaseChangeReport();
    message.configChanges =
      object.configChanges?.map((e) => ConfigChange.fromPartial(e)) || [];
    return message;
  },
};
...
export const Rollout = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Rollout {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          message.trafficPercentStrategy =
            Rollout_TrafficPercentStrategy.decode(reader, reader.uint32());
          break;
        case 200:
          message.deleteServiceStrategy = Rollout_DeleteServiceStrategy.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): Rollout {
    return {
      ...
      status: isSet(object.status)
        ? rollout_RolloutStatusFromJSON(object.status)
        : 0,
  ...
  toJSON(message: Rollout): unknown {
    ...
    message.trafficPercentStrategy !== undefined &&
      (obj.trafficPercentStrategy = message.trafficPercentStrategy
        ? Rollout_TrafficPercentStrategy.toJSON(message.trafficPercentStrategy)
        : undefined);
    message.deleteServiceStrategy !== undefined &&
      (obj.deleteServiceStrategy = message.deleteServiceStrategy
        ? Rollout_DeleteServiceStrategy.toJSON(message.deleteServiceStrategy)
        : undefined);
    message.serviceName !== undefined &&
      (obj.serviceName = message.serviceName);
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<Rollout>, I>>(object: I): Rollout {
    ...
    message.status = object.status ?? 0;
    message.trafficPercentStrategy =
      object.trafficPercentStrategy !== undefined &&
      object.trafficPercentStrategy !== null
        ? Rollout_TrafficPercentStrategy.fromPartial(
            object.trafficPercentStrategy
          )
        : undefined;
    message.deleteServiceStrategy =
      object.deleteServiceStrategy !== undefined &&
      object.deleteServiceStrategy !== null
        ? Rollout_DeleteServiceStrategy.fromPartial(
...
export const Rollout_TrafficPercentStrategy = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          const entry1 = Rollout_TrafficPercentStrategy_PercentagesEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromPartial<I extends Exact<DeepPartial<Rollout_TrafficPercentStrategy>, I>>(
    object: I
  ): Rollout_TrafficPercentStrategy {
    const message = createBaseRollout_TrafficPercentStrategy();
...
export const Rollout_TrafficPercentStrategy_PercentagesEntry = {
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<Rollout_TrafficPercentStrategy_PercentagesEntry>,
      I
    >
  >(object: I): Rollout_TrafficPercentStrategy_PercentagesEntry {
    const message = createBaseRollout_TrafficPercentStrategy_PercentagesEntry();
...
export const Rollout_DeleteServiceStrategy = {
  ...
  fromPartial<I extends Exact<DeepPartial<Rollout_DeleteServiceStrategy>, I>>(
    _: I
  ): Rollout_DeleteServiceStrategy {
    const message = createBaseRollout_DeleteServiceStrategy();
    return message;
