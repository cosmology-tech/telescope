...
import {
  ...
  ChangeReport,
  Diagnostic,
} from "../../../../google/api/servicemanagement/v1/resources";
...
export function getServiceConfigRequest_ConfigViewToJSON(
  object: GetServiceConfigRequest_ConfigView
): string {
  switch (object) {
...
export const ListServicesRequest = {
  ...
  toJSON(message: ListServicesRequest): unknown {
    const obj: any = {};
    message.producerProjectId !== undefined &&
...
export const ListServicesResponse = {
  ...
  toJSON(message: ListServicesResponse): unknown {
    ...
    if (message.services) {
      obj.services = message.services.map((e) =>
        e ? ManagedService.toJSON(e) : undefined
      );
    } else {
      obj.services = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListServicesResponse>, I>>(
    ...
    const message = createBaseListServicesResponse();
    message.services =
      object.services?.map((e) => ManagedService.fromPartial(e)) || [];
  ...
  fromJSON(object: any): CreateServiceRequest {
    return {
      service: isSet(object.service)
        ? ManagedService.fromJSON(object.service)
        : undefined,
    };
  },
  ...
  toJSON(message: CreateServiceRequest): unknown {
    ...
    message.service !== undefined &&
      (obj.service = message.service
        ? ManagedService.toJSON(message.service)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CreateServiceRequest>, I>>(
    object: I
  ): CreateServiceRequest {
    const message = createBaseCreateServiceRequest();
    message.service =
...
export const DeleteServiceRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteServiceRequest>, I>>(
    object: I
  ): DeleteServiceRequest {
    const message = createBaseDeleteServiceRequest();
    message.serviceName = object.serviceName ?? "";
...
export const UndeleteServiceRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<UndeleteServiceRequest>, I>>(
    object: I
  ): UndeleteServiceRequest {
    const message = createBaseUndeleteServiceRequest();
    message.serviceName = object.serviceName ?? "";
...
export const UndeleteServiceResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<UndeleteServiceResponse>, I>>(
    object: I
  ): UndeleteServiceResponse {
    const message = createBaseUndeleteServiceResponse();
    message.service =
...
export const GetServiceConfigRequest = {
  ...
  fromJSON(object: any): GetServiceConfigRequest {
    return {
      ...
      view: isSet(object.view)
        ? getServiceConfigRequest_ConfigViewFromJSON(object.view)
        : 0,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetServiceConfigRequest>, I>>(
    object: I
  ): GetServiceConfigRequest {
    const message = createBaseGetServiceConfigRequest();
    message.serviceName = object.serviceName ?? "";
...
export const ListServiceConfigsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListServiceConfigsRequest>, I>>(
    object: I
  ): ListServiceConfigsRequest {
    const message = createBaseListServiceConfigsRequest();
    message.serviceName = object.serviceName ?? "";
...
export const ListServiceConfigsResponse = {
  ...
  fromJSON(object: any): ListServiceConfigsResponse {
    return {
      serviceConfigs: Array.isArray(object?.serviceConfigs)
  ...
  toJSON(message: ListServiceConfigsResponse): unknown {
    ...
    if (message.serviceConfigs) {
      obj.serviceConfigs = message.serviceConfigs.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<ListServiceConfigsResponse>, I>>(
    object: I
  ): ListServiceConfigsResponse {
    const message = createBaseListServiceConfigsResponse();
    message.serviceConfigs =
      object.serviceConfigs?.map((e) => Service.fromPartial(e)) || [];
    message.nextPageToken = object.nextPageToken ?? "";
    return message;
  },
};
...
export const CreateServiceConfigRequest = {
  ...
  toJSON(message: CreateServiceConfigRequest): unknown {
    ...
    message.serviceName !== undefined &&
      (obj.serviceName = message.serviceName);
    message.serviceConfig !== undefined &&
      (obj.serviceConfig = message.serviceConfig
        ? Service.toJSON(message.serviceConfig)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CreateServiceConfigRequest>, I>>(
    object: I
  ): CreateServiceConfigRequest {
    const message = createBaseCreateServiceConfigRequest();
    message.serviceName = object.serviceName ?? "";
    message.serviceConfig =
      object.serviceConfig !== undefined && object.serviceConfig !== null
...
export const SubmitConfigSourceRequest = {
  ...
  toJSON(message: SubmitConfigSourceRequest): unknown {
    ...
    message.serviceName !== undefined &&
      (obj.serviceName = message.serviceName);
    message.configSource !== undefined &&
      (obj.configSource = message.configSource
        ? ConfigSource.toJSON(message.configSource)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<SubmitConfigSourceRequest>, I>>(
    object: I
  ): SubmitConfigSourceRequest {
    const message = createBaseSubmitConfigSourceRequest();
    message.serviceName = object.serviceName ?? "";
    message.configSource =
      object.configSource !== undefined && object.configSource !== null
...
export const SubmitConfigSourceResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<SubmitConfigSourceResponse>, I>>(
    object: I
  ): SubmitConfigSourceResponse {
    const message = createBaseSubmitConfigSourceResponse();
    message.serviceConfig =
...
export const CreateServiceRolloutRequest = {
  ...
  toJSON(message: CreateServiceRolloutRequest): unknown {
    ...
    message.serviceName !== undefined &&
      (obj.serviceName = message.serviceName);
    message.rollout !== undefined &&
      (obj.rollout = message.rollout
        ? Rollout.toJSON(message.rollout)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CreateServiceRolloutRequest>, I>>(
    object: I
  ): CreateServiceRolloutRequest {
    const message = createBaseCreateServiceRolloutRequest();
    message.serviceName = object.serviceName ?? "";
    message.rollout =
      object.rollout !== undefined && object.rollout !== null
...
export const ListServiceRolloutsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListServiceRolloutsRequest>, I>>(
    object: I
  ): ListServiceRolloutsRequest {
    const message = createBaseListServiceRolloutsRequest();
    message.serviceName = object.serviceName ?? "";
...
export const ListServiceRolloutsResponse = {
  ...
  fromJSON(object: any): ListServiceRolloutsResponse {
    return {
      rollouts: Array.isArray(object?.rollouts)
        ? object.rollouts.map((e: any) => Rollout.fromJSON(e))
        : [],
      nextPageToken: isSet(object.nextPageToken)
        ? String(object.nextPageToken)
        : "",
  ...
  toJSON(message: ListServiceRolloutsResponse): unknown {
    const obj: any = {};
    if (message.rollouts) {
      obj.rollouts = message.rollouts.map((e) =>
        e ? Rollout.toJSON(e) : undefined
      );
    } else {
      obj.rollouts = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListServiceRolloutsResponse>, I>>(
    object: I
  ): ListServiceRolloutsResponse {
    const message = createBaseListServiceRolloutsResponse();
    message.rollouts =
      object.rollouts?.map((e) => Rollout.fromPartial(e)) || [];
    message.nextPageToken = object.nextPageToken ?? "";
    return message;
  },
};
...
export const GetServiceRolloutRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetServiceRolloutRequest>, I>>(
    object: I
  ): GetServiceRolloutRequest {
    const message = createBaseGetServiceRolloutRequest();
    message.serviceName = object.serviceName ?? "";
...
export const GenerateConfigReportRequest = {
  ...
  toJSON(message: GenerateConfigReportRequest): unknown {
    const obj: any = {};
    message.newConfig !== undefined &&
      (obj.newConfig = message.newConfig
        ? Any.toJSON(message.newConfig)
        : undefined);
    message.oldConfig !== undefined &&
      (obj.oldConfig = message.oldConfig
        ? Any.toJSON(message.oldConfig)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<GenerateConfigReportRequest>, I>>(
    object: I
  ): GenerateConfigReportRequest {
    const message = createBaseGenerateConfigReportRequest();
    message.newConfig =
      object.newConfig !== undefined && object.newConfig !== null
        ? Any.fromPartial(object.newConfig)
        : undefined;
    message.oldConfig =
      object.oldConfig !== undefined && object.oldConfig !== null
...
export const GenerateConfigReportResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.changeReports.push(
            ChangeReport.decode(reader, reader.uint32())
          );
          break;
        case 4:
  ...
  fromJSON(object: any): GenerateConfigReportResponse {
    return {
      ...
      changeReports: Array.isArray(object?.changeReports)
  ...
  toJSON(message: GenerateConfigReportResponse): unknown {
    ...
    if (message.changeReports) {
      obj.changeReports = message.changeReports.map((e) =>
        e ? ChangeReport.toJSON(e) : undefined
      );
    } else {
      obj.changeReports = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GenerateConfigReportResponse>, I>>(
    object: I
  ): GenerateConfigReportResponse {
    const message = createBaseGenerateConfigReportResponse();
    message.serviceName = object.serviceName ?? "";
    ...
    message.changeReports =
      object.changeReports?.map((e) => ChangeReport.fromPartial(e)) || [];
    message.diagnostics =
...
export class ServiceManagerClientImpl implements ServiceManager {
  ...
  ListServiceConfigs(
    ...
    return promise.then((data) =>
      ListServiceConfigsResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ListServiceRollouts(
    ...
    return promise.then((data) =>
      ListServiceRolloutsResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  GenerateConfigReport(
    ...
    return promise.then((data) =>
      GenerateConfigReportResponse.decode(new _m0.Reader(data))
    );
  }
}
