...
export const HttpRequest = {
  ...
  fromJSON(object: any): HttpRequest {
    return {
      ...
      requestSize: isSet(object.requestSize)
        ? Long.fromString(object.requestSize)
        : Long.ZERO,
      status: isSet(object.status) ? Number(object.status) : 0,
      responseSize: isSet(object.responseSize)
        ? Long.fromString(object.responseSize)
        : Long.ZERO,
      ...
      latency: isSet(object.latency)
        ? Duration.fromJSON(object.latency)
        : undefined,
      cacheLookup: isSet(object.cacheLookup)
        ? Boolean(object.cacheLookup)
        : false,
      cacheHit: isSet(object.cacheHit) ? Boolean(object.cacheHit) : false,
      cacheValidatedWithOriginServer: isSet(
        object.cacheValidatedWithOriginServer
      )
        ? Boolean(object.cacheValidatedWithOriginServer)
        : false,
      cacheFillBytes: isSet(object.cacheFillBytes)
        ? Long.fromString(object.cacheFillBytes)
        : Long.ZERO,
  ...
  fromPartial<I extends Exact<DeepPartial<HttpRequest>, I>>(
    ...
    message.requestSize =
      object.requestSize !== undefined && object.requestSize !== null
    ...
    message.cacheFillBytes =
      object.cacheFillBytes !== undefined && object.cacheFillBytes !== null
