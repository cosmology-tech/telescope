...
export function logMetric_ApiVersionFromJSON(
  object: any
...
export function logMetric_ApiVersionToJSON(
  object: LogMetric_ApiVersion
): string {
  switch (object) {
...
export const LogMetric = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          break;
        case 5:
          message.metricDescriptor = MetricDescriptor.decode(
            reader,
            reader.uint32()
          );
          break;
        case 6:
          ...
          break;
        case 7:
          const entry7 = LogMetric_LabelExtractorsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): LogMetric {
    return {
      ...
      metricDescriptor: isSet(object.metricDescriptor)
        ? MetricDescriptor.fromJSON(object.metricDescriptor)
        : undefined,
      valueExtractor: isSet(object.valueExtractor)
        ? String(object.valueExtractor)
        : "",
      labelExtractors: isObject(object.labelExtractors)
        ? Object.entries(object.labelExtractors).reduce<{
            [key: string]: string;
          }>((acc, [key, value]) => {
      ...
      version: isSet(object.version)
        ? logMetric_ApiVersionFromJSON(object.version)
        : 0,
    };
  },
  ...
  toJSON(message: LogMetric): unknown {
    ...
    message.metricDescriptor !== undefined &&
      (obj.metricDescriptor = message.metricDescriptor
        ? MetricDescriptor.toJSON(message.metricDescriptor)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<LogMetric>, I>>(
    ...
    message.metricDescriptor =
      object.metricDescriptor !== undefined && object.metricDescriptor !== null
        ? MetricDescriptor.fromPartial(object.metricDescriptor)
        : undefined;
    message.valueExtractor = object.valueExtractor ?? "";
    message.labelExtractors = Object.entries(
...
export const LogMetric_LabelExtractorsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<LogMetric_LabelExtractorsEntry>, I>>(
    object: I
  ): LogMetric_LabelExtractorsEntry {
    const message = createBaseLogMetric_LabelExtractorsEntry();
...
export const ListLogMetricsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListLogMetricsRequest>, I>>(
    object: I
  ): ListLogMetricsRequest {
    const message = createBaseListLogMetricsRequest();
...
export const ListLogMetricsResponse = {
  ...
  fromJSON(object: any): ListLogMetricsResponse {
    return {
      metrics: Array.isArray(object?.metrics)
        ? object.metrics.map((e: any) => LogMetric.fromJSON(e))
        : [],
  ...
  toJSON(message: ListLogMetricsResponse): unknown {
    ...
    if (message.metrics) {
      obj.metrics = message.metrics.map((e) =>
        e ? LogMetric.toJSON(e) : undefined
      );
    } else {
      obj.metrics = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListLogMetricsResponse>, I>>(
    object: I
  ): ListLogMetricsResponse {
    const message = createBaseListLogMetricsResponse();
    message.metrics =
      object.metrics?.map((e) => LogMetric.fromPartial(e)) || [];
...
export const GetLogMetricRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetLogMetricRequest>, I>>(
    object: I
  ): GetLogMetricRequest {
    const message = createBaseGetLogMetricRequest();
  ...
  fromJSON(object: any): CreateLogMetricRequest {
    return {
      ...
      metric: isSet(object.metric)
        ? LogMetric.fromJSON(object.metric)
        : undefined,
    };
  },
  ...
  toJSON(message: CreateLogMetricRequest): unknown {
    ...
    message.metric !== undefined &&
      (obj.metric = message.metric
        ? LogMetric.toJSON(message.metric)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CreateLogMetricRequest>, I>>(
    object: I
  ): CreateLogMetricRequest {
    const message = createBaseCreateLogMetricRequest();
    message.parent = object.parent ?? "";
...
export const UpdateLogMetricRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateLogMetricRequest>, I>>(
    object: I
  ): UpdateLogMetricRequest {
    const message = createBaseUpdateLogMetricRequest();
    message.metricName = object.metricName ?? "";
...
export const DeleteLogMetricRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteLogMetricRequest>, I>>(
    object: I
  ): DeleteLogMetricRequest {
    const message = createBaseDeleteLogMetricRequest();
    message.metricName = object.metricName ?? "";
...
export class MetricsServiceV2ClientImpl implements MetricsServiceV2 {
  private readonly rpc: Rpc;
  constructor(rpc: Rpc) {
    this.rpc = rpc;
    this.ListLogMetrics = this.ListLogMetrics.bind(this);
    this.GetLogMetric = this.GetLogMetric.bind(this);
    this.CreateLogMetric = this.CreateLogMetric.bind(this);
    this.UpdateLogMetric = this.UpdateLogMetric.bind(this);
    this.DeleteLogMetric = this.DeleteLogMetric.bind(this);
  }
  ListLogMetrics(
    request: ListLogMetricsRequest
  ): Promise<ListLogMetricsResponse> {
    const data = ListLogMetricsRequest.encode(request).finish();
    ...
    return promise.then((data) =>
      ListLogMetricsResponse.decode(new _m0.Reader(data))
    );
  }

  GetLogMetric(request: GetLogMetricRequest): Promise<LogMetric> {
    const data = GetLogMetricRequest.encode(request).finish();
    const promise = this.rpc.request(
      "google.logging.v2.MetricsServiceV2",
      "GetLogMetric",
      data
    );
    return promise.then((data) => LogMetric.decode(new _m0.Reader(data)));
  }

  CreateLogMetric(request: CreateLogMetricRequest): Promise<LogMetric> {
    const data = CreateLogMetricRequest.encode(request).finish();
    const promise = this.rpc.request(
      "google.logging.v2.MetricsServiceV2",
      "CreateLogMetric",
      data
  ...
  UpdateLogMetric(request: UpdateLogMetricRequest): Promise<LogMetric> {
    const data = UpdateLogMetricRequest.encode(request).finish();
    const promise = this.rpc.request(
      "google.logging.v2.MetricsServiceV2",
      "UpdateLogMetric",
      data
  ...
  DeleteLogMetric(request: DeleteLogMetricRequest): Promise<Empty> {
    const data = DeleteLogMetricRequest.encode(request).finish();
    const promise = this.rpc.request(
      "google.logging.v2.MetricsServiceV2",
      "DeleteLogMetric",
      data
