...
export function logSink_VersionFormatToJSON(
  object: LogSink_VersionFormat
): string {
  switch (object) {
...
export const LogBucket = {
  ...
  fromJSON(object: any): LogBucket {
    return {
      ...
      lifecycleState: isSet(object.lifecycleState)
        ? lifecycleStateFromJSON(object.lifecycleState)
        : 0,
      restrictedFields: Array.isArray(object?.restrictedFields)
        ? object.restrictedFields.map((e: any) => String(e))
        : [],
      cmekSettings: isSet(object.cmekSettings)
        ? CmekSettings.fromJSON(object.cmekSettings)
        : undefined,
    };
  },
  ...
  toJSON(message: LogBucket): unknown {
    ...
    message.lifecycleState !== undefined &&
    ...
    message.cmekSettings !== undefined &&
      (obj.cmekSettings = message.cmekSettings
        ? CmekSettings.toJSON(message.cmekSettings)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<LogBucket>, I>>(
    object: I
  ): LogBucket {
    const message = createBaseLogBucket();
    ...
    message.cmekSettings =
      object.cmekSettings !== undefined && object.cmekSettings !== null
...
export const LogSink = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          break;
        case 12:
          message.bigqueryOptions = BigQueryOptions.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): LogSink {
    return {
      ...
      outputVersionFormat: isSet(object.outputVersionFormat)
        ...
        : 0,
      writerIdentity: isSet(object.writerIdentity)
        ? String(object.writerIdentity)
        : "",
      includeChildren: isSet(object.includeChildren)
        ? Boolean(object.includeChildren)
        : false,
      bigqueryOptions: isSet(object.bigqueryOptions)
  ...
  toJSON(message: LogSink): unknown {
    ...
    if (message.exclusions) {
      obj.exclusions = message.exclusions.map((e) =>
        e ? LogExclusion.toJSON(e) : undefined
      );
    } else {
      obj.exclusions = [];
    }
    message.outputVersionFormat !== undefined &&
      (obj.outputVersionFormat = logSink_VersionFormatToJSON(
        message.outputVersionFormat
      ));
    message.writerIdentity !== undefined &&
      (obj.writerIdentity = message.writerIdentity);
    message.includeChildren !== undefined &&
      (obj.includeChildren = message.includeChildren);
    message.bigqueryOptions !== undefined &&
      (obj.bigqueryOptions = message.bigqueryOptions
        ? BigQueryOptions.toJSON(message.bigqueryOptions)
        : undefined);
    message.createTime !== undefined &&
      (obj.createTime = message.createTime.toISOString());
    message.updateTime !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<LogSink>, I>>(object: I): LogSink {
    ...
    message.exclusions =
      object.exclusions?.map((e) => LogExclusion.fromPartial(e)) || [];
    ...
    message.bigqueryOptions =
      object.bigqueryOptions !== undefined && object.bigqueryOptions !== null
...
export const BigQueryOptions = {
  ...
  fromJSON(object: any): BigQueryOptions {
    return {
      usePartitionedTables: isSet(object.usePartitionedTables)
        ? Boolean(object.usePartitionedTables)
        : false,
      usesTimestampColumnPartitioning: isSet(
        object.usesTimestampColumnPartitioning
      )
        ? Boolean(object.usesTimestampColumnPartitioning)
        : false,
    };
  },
  ...
  toJSON(message: BigQueryOptions): unknown {
    const obj: any = {};
    message.usePartitionedTables !== undefined &&
      (obj.usePartitionedTables = message.usePartitionedTables);
    message.usesTimestampColumnPartitioning !== undefined &&
      (obj.usesTimestampColumnPartitioning =
        message.usesTimestampColumnPartitioning);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<BigQueryOptions>, I>>(
    object: I
  ): BigQueryOptions {
    const message = createBaseBigQueryOptions();
...
export const ListBucketsResponse = {
  ...
  fromJSON(object: any): ListBucketsResponse {
    return {
      buckets: Array.isArray(object?.buckets)
        ? object.buckets.map((e: any) => LogBucket.fromJSON(e))
        : [],
  ...
  toJSON(message: ListBucketsResponse): unknown {
    ...
    if (message.buckets) {
      obj.buckets = message.buckets.map((e) =>
        e ? LogBucket.toJSON(e) : undefined
      );
    } else {
      obj.buckets = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<ListBucketsResponse>, I>>(
    ...
    const message = createBaseListBucketsResponse();
    message.buckets =
      object.buckets?.map((e) => LogBucket.fromPartial(e)) || [];
  ...
  fromJSON(object: any): CreateBucketRequest {
    return {
      ...
      bucket: isSet(object.bucket)
        ? LogBucket.fromJSON(object.bucket)
        : undefined,
    };
  },
  ...
  toJSON(message: CreateBucketRequest): unknown {
    ...
    message.bucket !== undefined &&
      (obj.bucket = message.bucket
        ? LogBucket.toJSON(message.bucket)
        : undefined);
    return obj;
  },
...
export const UndeleteBucketRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<UndeleteBucketRequest>, I>>(
    object: I
  ): UndeleteBucketRequest {
    const message = createBaseUndeleteBucketRequest();
    message.name = object.name ?? "";
...
export const ListViewsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListViewsRequest>, I>>(
    object: I
  ): ListViewsRequest {
    const message = createBaseListViewsRequest();
    message.parent = object.parent ?? "";
...
export const ListViewsResponse = {
  ...
  fromJSON(object: any): ListViewsResponse {
    return {
      views: Array.isArray(object?.views)
        ? object.views.map((e: any) => LogView.fromJSON(e))
        : [],
      nextPageToken: isSet(object.nextPageToken)
        ? String(object.nextPageToken)
        : "",
  ...
  fromPartial<I extends Exact<DeepPartial<ListViewsResponse>, I>>(
    object: I
  ): ListViewsResponse {
    const message = createBaseListViewsResponse();
...
export const CreateViewRequest = {
  ...
  toJSON(message: CreateViewRequest): unknown {
    ...
    message.view !== undefined &&
      (obj.view = message.view ? LogView.toJSON(message.view) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CreateViewRequest>, I>>(
    object: I
  ): CreateViewRequest {
    const message = createBaseCreateViewRequest();
    message.parent = object.parent ?? "";
    ...
    message.view =
      object.view !== undefined && object.view !== null
        ? LogView.fromPartial(object.view)
        : undefined;
    return message;
  },
};
...
export const UpdateViewRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateViewRequest>, I>>(
    object: I
  ): UpdateViewRequest {
    const message = createBaseUpdateViewRequest();
    message.name = object.name ?? "";
...
export const GetViewRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetViewRequest>, I>>(
    object: I
  ): GetViewRequest {
    const message = createBaseGetViewRequest();
    message.name = object.name ?? "";
...
export const DeleteViewRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteViewRequest>, I>>(
    object: I
  ): DeleteViewRequest {
    const message = createBaseDeleteViewRequest();
    message.name = object.name ?? "";
...
export const ListSinksResponse = {
  ...
  fromJSON(object: any): ListSinksResponse {
    return {
      sinks: Array.isArray(object?.sinks)
        ? object.sinks.map((e: any) => LogSink.fromJSON(e))
        : [],
      nextPageToken: isSet(object.nextPageToken)
        ? String(object.nextPageToken)
        : "",
...
export const CreateSinkRequest = {
  ...
  fromJSON(object: any): CreateSinkRequest {
    return {
      ...
      uniqueWriterIdentity: isSet(object.uniqueWriterIdentity)
        ? Boolean(object.uniqueWriterIdentity)
        : false,
    };
  },
  ...
  toJSON(message: CreateSinkRequest): unknown {
    const obj: any = {};
    message.parent !== undefined && (obj.parent = message.parent);
    message.sink !== undefined &&
      (obj.sink = message.sink ? LogSink.toJSON(message.sink) : undefined);
    message.uniqueWriterIdentity !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<CreateSinkRequest>, I>>(
    ...
    message.parent = object.parent ?? "";
    message.sink =
      object.sink !== undefined && object.sink !== null
        ? LogSink.fromPartial(object.sink)
        : undefined;
...
export const LogExclusion = {
  ...
  fromPartial<I extends Exact<DeepPartial<LogExclusion>, I>>(
    object: I
  ): LogExclusion {
    const message = createBaseLogExclusion();
    message.name = object.name ?? "";
...
export const ListExclusionsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListExclusionsRequest>, I>>(
    object: I
  ): ListExclusionsRequest {
    const message = createBaseListExclusionsRequest();
    message.parent = object.parent ?? "";
...
export const ListExclusionsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListExclusionsResponse>, I>>(
    object: I
  ): ListExclusionsResponse {
    const message = createBaseListExclusionsResponse();
    message.exclusions =
...
export const GetExclusionRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetExclusionRequest>, I>>(
    object: I
  ): GetExclusionRequest {
    const message = createBaseGetExclusionRequest();
    message.name = object.name ?? "";
...
export const CreateExclusionRequest = {
  ...
  fromJSON(object: any): CreateExclusionRequest {
    return {
      parent: isSet(object.parent) ? String(object.parent) : "",
      exclusion: isSet(object.exclusion)
        ? LogExclusion.fromJSON(object.exclusion)
        : undefined,
    };
  },
  ...
  toJSON(message: CreateExclusionRequest): unknown {
    const obj: any = {};
    message.parent !== undefined && (obj.parent = message.parent);
    message.exclusion !== undefined &&
      (obj.exclusion = message.exclusion
        ? LogExclusion.toJSON(message.exclusion)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CreateExclusionRequest>, I>>(
    object: I
  ): CreateExclusionRequest {
    const message = createBaseCreateExclusionRequest();
    message.parent = object.parent ?? "";
...
export const UpdateExclusionRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateExclusionRequest>, I>>(
    object: I
  ): UpdateExclusionRequest {
    const message = createBaseUpdateExclusionRequest();
    message.name = object.name ?? "";
...
export const DeleteExclusionRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteExclusionRequest>, I>>(
    object: I
  ): DeleteExclusionRequest {
    const message = createBaseDeleteExclusionRequest();
    message.name = object.name ?? "";
...
export const GetCmekSettingsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetCmekSettingsRequest>, I>>(
    object: I
  ): GetCmekSettingsRequest {
    const message = createBaseGetCmekSettingsRequest();
    message.name = object.name ?? "";
...
export const UpdateCmekSettingsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateCmekSettingsRequest>, I>>(
    object: I
  ): UpdateCmekSettingsRequest {
    const message = createBaseUpdateCmekSettingsRequest();
    message.name = object.name ?? "";
...
function createBaseCmekSettings(): CmekSettings {
  return { name: "", kmsKeyName: "", serviceAccountId: "" };
}
...
export const CmekSettings = {
  ...
  fromJSON(object: any): CmekSettings {
    return {
      ...
      serviceAccountId: isSet(object.serviceAccountId)
  ...
  fromPartial<I extends Exact<DeepPartial<CmekSettings>, I>>(
    object: I
  ): CmekSettings {
    const message = createBaseCmekSettings();
    message.name = object.name ?? "";
...
export const GetSettingsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetSettingsRequest>, I>>(
    object: I
  ): GetSettingsRequest {
    const message = createBaseGetSettingsRequest();
    message.name = object.name ?? "";
...
export const Settings = {
  ...
  fromJSON(object: any): Settings {
    return {
      name: isSet(object.name) ? String(object.name) : "",
      kmsKeyName: isSet(object.kmsKeyName) ? String(object.kmsKeyName) : "",
      kmsServiceAccountId: isSet(object.kmsServiceAccountId)
        ? String(object.kmsServiceAccountId)
        : "",
      storageLocation: isSet(object.storageLocation)
        ? String(object.storageLocation)
        : "",
      disableDefaultSink: isSet(object.disableDefaultSink)
  ...
  toJSON(message: Settings): unknown {
    ...
    message.name !== undefined && (obj.name = message.name);
    message.kmsKeyName !== undefined && (obj.kmsKeyName = message.kmsKeyName);
    message.kmsServiceAccountId !== undefined &&
      (obj.kmsServiceAccountId = message.kmsServiceAccountId);
    message.storageLocation !== undefined &&
      (obj.storageLocation = message.storageLocation);
    message.disableDefaultSink !== undefined &&
...
export const CopyLogEntriesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<CopyLogEntriesRequest>, I>>(
    object: I
  ): CopyLogEntriesRequest {
    const message = createBaseCopyLogEntriesRequest();
    message.name = object.name ?? "";
...
export const CopyLogEntriesMetadata = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.request = CopyLogEntriesRequest.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): CopyLogEntriesMetadata {
    return {
      ...
      request: isSet(object.request)
        ? CopyLogEntriesRequest.fromJSON(object.request)
        : undefined,
  ...
  toJSON(message: CopyLogEntriesMetadata): unknown {
    ...
    message.cancellationRequested !== undefined &&
      (obj.cancellationRequested = message.cancellationRequested);
    message.request !== undefined &&
      (obj.request = message.request
        ? CopyLogEntriesRequest.toJSON(message.request)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<CopyLogEntriesMetadata>, I>>(
    object: I
  ): CopyLogEntriesMetadata {
    const message = createBaseCopyLogEntriesMetadata();
...
export const CopyLogEntriesResponse = {
  ...
  fromJSON(object: any): CopyLogEntriesResponse {
    return {
      logEntriesCopiedCount: isSet(object.logEntriesCopiedCount)
        ? Long.fromString(object.logEntriesCopiedCount)
        : Long.ZERO,
    };
  },
  ...
  toJSON(message: CopyLogEntriesResponse): unknown {
    const obj: any = {};
    message.logEntriesCopiedCount !== undefined &&
      (obj.logEntriesCopiedCount = (
        message.logEntriesCopiedCount || Long.ZERO
      ).toString());
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CopyLogEntriesResponse>, I>>(
    object: I
  ): CopyLogEntriesResponse {
    const message = createBaseCopyLogEntriesResponse();
    message.logEntriesCopiedCount =
      object.logEntriesCopiedCount !== undefined &&
      object.logEntriesCopiedCount !== null
...
export class ConfigServiceV2ClientImpl implements ConfigServiceV2 {
  ...
  ListViews(request: ListViewsRequest): Promise<ListViewsResponse> {
    ...
    return promise.then((data) =>
      ListViewsResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ListSinks(request: ListSinksRequest): Promise<ListSinksResponse> {
    ...
    return promise.then((data) =>
      ListSinksResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ListExclusions(
    ...
    return promise.then((data) =>
      ListExclusionsResponse.decode(new _m0.Reader(data))
    );
  }
