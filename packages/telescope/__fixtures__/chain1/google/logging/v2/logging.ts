...
} from "../../../google/api/monitored_resource";
...
export const DeleteLogRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteLogRequest>, I>>(
    object: I
  ): DeleteLogRequest {
    const message = createBaseDeleteLogRequest();
...
export const WriteLogEntriesRequest = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          const entry3 = WriteLogEntriesRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
  ...
  fromJSON(object: any): WriteLogEntriesRequest {
    return {
      ...
      resource: isSet(object.resource)
        ? MonitoredResource.fromJSON(object.resource)
        : undefined,
  ...
  toJSON(message: WriteLogEntriesRequest): unknown {
    ...
    message.resource !== undefined &&
      (obj.resource = message.resource
        ? MonitoredResource.toJSON(message.resource)
        : undefined);
    obj.labels = {};
    if (message.labels) {
  ...
  fromPartial<I extends Exact<DeepPartial<WriteLogEntriesRequest>, I>>(
    object: I
  ): WriteLogEntriesRequest {
    const message = createBaseWriteLogEntriesRequest();
    message.logName = object.logName ?? "";
...
export const WriteLogEntriesRequest_LabelsEntry = {
  encode(
    message: WriteLogEntriesRequest_LabelsEntry,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.key !== "") {
  ...
  fromPartial<
    I extends Exact<DeepPartial<WriteLogEntriesRequest_LabelsEntry>, I>
  >(object: I): WriteLogEntriesRequest_LabelsEntry {
    const message = createBaseWriteLogEntriesRequest_LabelsEntry();
...
export const WriteLogEntriesResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<WriteLogEntriesResponse>, I>>(
    _: I
  ): WriteLogEntriesResponse {
    const message = createBaseWriteLogEntriesResponse();
    return message;
...
export const WriteLogEntriesPartialErrors = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          const entry1 =
            WriteLogEntriesPartialErrors_LogEntryErrorsEntry.decode(
              reader,
              reader.uint32()
            );
  ...
  fromJSON(object: any): WriteLogEntriesPartialErrors {
    return {
      logEntryErrors: isObject(object.logEntryErrors)
        ? Object.entries(object.logEntryErrors).reduce<{
            [key: number]: Status;
          }>((acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<WriteLogEntriesPartialErrors>, I>>(
    object: I
  ): WriteLogEntriesPartialErrors {
    const message = createBaseWriteLogEntriesPartialErrors();
    message.logEntryErrors = Object.entries(
      object.logEntryErrors ?? {}
    ).reduce<{ [key: number]: Status }>((acc, [key, value]) => {
      if (value !== undefined) {
...
export const WriteLogEntriesPartialErrors_LogEntryErrorsEntry = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message =
      createBaseWriteLogEntriesPartialErrors_LogEntryErrorsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<WriteLogEntriesPartialErrors_LogEntryErrorsEntry>,
      I
    >
  >(object: I): WriteLogEntriesPartialErrors_LogEntryErrorsEntry {
    const message =
      createBaseWriteLogEntriesPartialErrors_LogEntryErrorsEntry();
...
export const ListLogEntriesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListLogEntriesRequest>, I>>(
    object: I
  ): ListLogEntriesRequest {
    const message = createBaseListLogEntriesRequest();
...
export const ListLogEntriesResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListLogEntriesResponse>, I>>(
    object: I
  ): ListLogEntriesResponse {
    const message = createBaseListLogEntriesResponse();
    message.entries = object.entries?.map((e) => LogEntry.fromPartial(e)) || [];
...
export const ListMonitoredResourceDescriptorsRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<ListMonitoredResourceDescriptorsRequest>, I>
  >(object: I): ListMonitoredResourceDescriptorsRequest {
    const message = createBaseListMonitoredResourceDescriptorsRequest();
    message.pageSize = object.pageSize ?? 0;
    message.pageToken = object.pageToken ?? "";
    return message;
...
export const ListMonitoredResourceDescriptorsResponse = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.resourceDescriptors.push(
  ...
  fromJSON(object: any): ListMonitoredResourceDescriptorsResponse {
    return {
      resourceDescriptors: Array.isArray(object?.resourceDescriptors)
        ? object.resourceDescriptors.map((e: any) =>
  ...
  toJSON(message: ListMonitoredResourceDescriptorsResponse): unknown {
    ...
    if (message.resourceDescriptors) {
      obj.resourceDescriptors = message.resourceDescriptors.map((e) =>
  ...
  fromPartial<
    I extends Exact<DeepPartial<ListMonitoredResourceDescriptorsResponse>, I>
  >(object: I): ListMonitoredResourceDescriptorsResponse {
    const message = createBaseListMonitoredResourceDescriptorsResponse();
    message.resourceDescriptors =
      object.resourceDescriptors?.map((e) =>
...
function createBaseListLogsRequest(): ListLogsRequest {
  return { parent: "", pageSize: 0, pageToken: "", resourceNames: [] };
}
...
export const ListLogsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<ListLogsRequest>, I>>(
    object: I
  ): ListLogsRequest {
    const message = createBaseListLogsRequest();
...
export const ListLogsResponse = {
  ...
  fromJSON(object: any): ListLogsResponse {
    return {
      logNames: Array.isArray(object?.logNames)
        ? object.logNames.map((e: any) => String(e))
        : [],
      nextPageToken: isSet(object.nextPageToken)
        ? String(object.nextPageToken)
        : "",
  ...
  fromPartial<I extends Exact<DeepPartial<ListLogsResponse>, I>>(
    object: I
  ): ListLogsResponse {
    const message = createBaseListLogsResponse();
...
export const TailLogEntriesRequest = {
  ...
  fromJSON(object: any): TailLogEntriesRequest {
    return {
      resourceNames: Array.isArray(object?.resourceNames)
        ...
        : [],
      filter: isSet(object.filter) ? String(object.filter) : "",
      bufferWindow: isSet(object.bufferWindow)
  ...
  toJSON(message: TailLogEntriesRequest): unknown {
    ...
    message.filter !== undefined && (obj.filter = message.filter);
    message.bufferWindow !== undefined &&
      (obj.bufferWindow = message.bufferWindow
        ? Duration.toJSON(message.bufferWindow)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<TailLogEntriesRequest>, I>>(
    object: I
  ): TailLogEntriesRequest {
    const message = createBaseTailLogEntriesRequest();
    message.resourceNames = object.resourceNames?.map((e) => e) || [];
    message.filter = object.filter ?? "";
    message.bufferWindow =
      object.bufferWindow !== undefined && object.bufferWindow !== null
...
export const TailLogEntriesResponse = {
  encode(
    ...
    for (const v of message.suppressionInfo) {
      TailLogEntriesResponse_SuppressionInfo.encode(
        v!,
        writer.uint32(18).fork()
      ).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.suppressionInfo.push(
            TailLogEntriesResponse_SuppressionInfo.decode(
              reader,
              reader.uint32()
            )
          );
  ...
  fromJSON(object: any): TailLogEntriesResponse {
    return {
      entries: Array.isArray(object?.entries)
        ? object.entries.map((e: any) => LogEntry.fromJSON(e))
        : [],
      suppressionInfo: Array.isArray(object?.suppressionInfo)
        ? object.suppressionInfo.map((e: any) =>
            TailLogEntriesResponse_SuppressionInfo.fromJSON(e)
          )
        : [],
    };
  },
  ...
  toJSON(message: TailLogEntriesResponse): unknown {
    ...
    if (message.suppressionInfo) {
      obj.suppressionInfo = message.suppressionInfo.map((e) =>
        e ? TailLogEntriesResponse_SuppressionInfo.toJSON(e) : undefined
      );
    } else {
      obj.suppressionInfo = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<TailLogEntriesResponse>, I>>(
    object: I
  ): TailLogEntriesResponse {
    const message = createBaseTailLogEntriesResponse();
    message.entries = object.entries?.map((e) => LogEntry.fromPartial(e)) || [];
    message.suppressionInfo =
      object.suppressionInfo?.map((e) =>
        TailLogEntriesResponse_SuppressionInfo.fromPartial(e)
      ) || [];
    return message;
  },
};
...
export const TailLogEntriesResponse_SuppressionInfo = {
  encode(
    message: TailLogEntriesResponse_SuppressionInfo,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (message.reason !== 0) {
  ...
  fromJSON(object: any): TailLogEntriesResponse_SuppressionInfo {
    return {
      reason: isSet(object.reason)
        ? tailLogEntriesResponse_SuppressionInfo_ReasonFromJSON(object.reason)
        : 0,
      suppressedCount: isSet(object.suppressedCount)
        ? Number(object.suppressedCount)
        : 0,
    };
  },
  ...
  toJSON(message: TailLogEntriesResponse_SuppressionInfo): unknown {
    ...
    message.reason !== undefined &&
      (obj.reason = tailLogEntriesResponse_SuppressionInfo_ReasonToJSON(
        message.reason
      ));
    message.suppressedCount !== undefined &&
      (obj.suppressedCount = Math.round(message.suppressedCount));
    return obj;
  },

  fromPartial<
    I extends Exact<DeepPartial<TailLogEntriesResponse_SuppressionInfo>, I>
  >(object: I): TailLogEntriesResponse_SuppressionInfo {
    const message = createBaseTailLogEntriesResponse_SuppressionInfo();
...
export interface LoggingServiceV2 {
   ...
   */
  TailLogEntries(
    request: Observable<TailLogEntriesRequest>
  ): Observable<TailLogEntriesResponse>;
}

export class LoggingServiceV2ClientImpl implements LoggingServiceV2 {
  private readonly rpc: Rpc;
  constructor(rpc: Rpc) {
    this.rpc = rpc;
    this.DeleteLog = this.DeleteLog.bind(this);
    this.WriteLogEntries = this.WriteLogEntries.bind(this);
    this.ListLogEntries = this.ListLogEntries.bind(this);
    this.ListMonitoredResourceDescriptors =
      this.ListMonitoredResourceDescriptors.bind(this);
    this.ListLogs = this.ListLogs.bind(this);
    this.TailLogEntries = this.TailLogEntries.bind(this);
  }
  DeleteLog(request: DeleteLogRequest): Promise<Empty> {
    const data = DeleteLogRequest.encode(request).finish();
  ...
  WriteLogEntries(
    ...
    const data = WriteLogEntriesRequest.encode(request).finish();
    const promise = this.rpc.request(
      "google.logging.v2.LoggingServiceV2",
      "WriteLogEntries",
      data
    ...
    return promise.then((data) =>
      WriteLogEntriesResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ListLogEntries(
    ...
    return promise.then((data) =>
      ListLogEntriesResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ListMonitoredResourceDescriptors(
    ...
    const data =
      ListMonitoredResourceDescriptorsRequest.encode(request).finish();
    const promise = this.rpc.request(
      "google.logging.v2.LoggingServiceV2",
      "ListMonitoredResourceDescriptors",
      data
    ...
    return promise.then((data) =>
      ListMonitoredResourceDescriptorsResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ListLogs(request: ListLogsRequest): Promise<ListLogsResponse> {
    ...
    return promise.then((data) =>
      ListLogsResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  TailLogEntries(
    ...
    const data = request.pipe(
      map((request) => TailLogEntriesRequest.encode(request).finish())
    );
    ...
    return result.pipe(
      map((data) => TailLogEntriesResponse.decode(new _m0.Reader(data)))
    );
  }
}
