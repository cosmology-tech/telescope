...
import {
  ...
  logSeverityFromJSON,
  logSeverityToJSON,
} from "../../../google/logging/type/log_severity";
...
export interface LogEntry {
   ...
   */
  jsonPayload: { [key: string]: any } | undefined;
  /**
...
export const LogEntry = {
  encode(
    ...
    if (message.receiveTimestamp !== undefined) {
      Timestamp.encode(
        toTimestamp(message.receiveTimestamp),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          break;
        case 24:
          message.receiveTimestamp = fromTimestamp(
            Timestamp.decode(reader, reader.uint32())
          );
          break;
        case 10:
        ...
        case 30:
          ...
          break;
        case 23:
          message.sourceLocation = LogEntrySourceLocation.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): LogEntry {
    return {
      ...
      resource: isSet(object.resource)
        ...
        : undefined,
      protoPayload: isSet(object.protoPayload)
        ? Any.fromJSON(object.protoPayload)
        : undefined,
      textPayload: isSet(object.textPayload)
        ? String(object.textPayload)
        : undefined,
      jsonPayload: isObject(object.jsonPayload)
        ? object.jsonPayload
        : undefined,
      timestamp: isSet(object.timestamp)
        ? fromJsonTimestamp(object.timestamp)
        : undefined,
      receiveTimestamp: isSet(object.receiveTimestamp)
        ? fromJsonTimestamp(object.receiveTimestamp)
        : undefined,
      ...
      httpRequest: isSet(object.httpRequest)
        ? HttpRequest.fromJSON(object.httpRequest)
        : undefined,
      ...
      operation: isSet(object.operation)
        ? LogEntryOperation.fromJSON(object.operation)
        : undefined,
      trace: isSet(object.trace) ? String(object.trace) : "",
      spanId: isSet(object.spanId) ? String(object.spanId) : "",
      traceSampled: isSet(object.traceSampled)
        ? Boolean(object.traceSampled)
        : false,
      sourceLocation: isSet(object.sourceLocation)
        ? LogEntrySourceLocation.fromJSON(object.sourceLocation)
        : undefined,
  ...
  toJSON(message: LogEntry): unknown {
    ...
    message.resource !== undefined &&
      (obj.resource = message.resource
        ...
        : undefined);
    message.protoPayload !== undefined &&
      (obj.protoPayload = message.protoPayload
        ? Any.toJSON(message.protoPayload)
        : undefined);
    ...
    message.receiveTimestamp !== undefined &&
    ...
    message.httpRequest !== undefined &&
      (obj.httpRequest = message.httpRequest
        ? HttpRequest.toJSON(message.httpRequest)
        : undefined);
    obj.labels = {};
    if (message.labels) {
    ...
    message.operation !== undefined &&
      (obj.operation = message.operation
        ? LogEntryOperation.toJSON(message.operation)
        : undefined);
    message.trace !== undefined && (obj.trace = message.trace);
    message.spanId !== undefined && (obj.spanId = message.spanId);
    message.traceSampled !== undefined &&
      (obj.traceSampled = message.traceSampled);
    message.sourceLocation !== undefined &&
      (obj.sourceLocation = message.sourceLocation
        ? LogEntrySourceLocation.toJSON(message.sourceLocation)
        : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<LogEntry>, I>>(object: I): LogEntry {
    ...
    message.protoPayload =
      object.protoPayload !== undefined && object.protoPayload !== null
    ...
    message.httpRequest =
      object.httpRequest !== undefined && object.httpRequest !== null
    ...
    message.sourceLocation =
      object.sourceLocation !== undefined && object.sourceLocation !== null
        ? LogEntrySourceLocation.fromPartial(object.sourceLocation)
        : undefined;
    message.split =
      object.split !== undefined && object.split !== null
...
export const LogEntry_LabelsEntry = {
  ...
  fromPartial<I extends Exact<DeepPartial<LogEntry_LabelsEntry>, I>>(
    object: I
  ): LogEntry_LabelsEntry {
    const message = createBaseLogEntry_LabelsEntry();
...
export const LogEntryOperation = {
  ...
  fromPartial<I extends Exact<DeepPartial<LogEntryOperation>, I>>(
    object: I
  ): LogEntryOperation {
    const message = createBaseLogEntryOperation();
...
export const LogEntrySourceLocation = {
  ...
  fromPartial<I extends Exact<DeepPartial<LogEntrySourceLocation>, I>>(
    object: I
  ): LogEntrySourceLocation {
    const message = createBaseLogEntrySourceLocation();
