...
export const DeleteOperationRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<DeleteOperationRequest>, I>>(
    object: I
  ): DeleteOperationRequest {
    const message = createBaseDeleteOperationRequest();
    message.name = object.name ?? "";
...
export const WaitOperationRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<WaitOperationRequest>, I>>(
    object: I
  ): WaitOperationRequest {
    const message = createBaseWaitOperationRequest();
    message.name = object.name ?? "";
...
export const OperationInfo = {
  ...
  fromJSON(object: any): OperationInfo {
    return {
      responseType: isSet(object.responseType)
        ...
        : "",
      metadataType: isSet(object.metadataType)
        ? String(object.metadataType)
        : "",
    };
  },
  ...
  toJSON(message: OperationInfo): unknown {
    ...
    message.metadataType !== undefined &&
      (obj.metadataType = message.metadataType);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<OperationInfo>, I>>(
    object: I
  ): OperationInfo {
    const message = createBaseOperationInfo();
...
export class OperationsClientImpl implements Operations {
  ...
  ListOperations(
    ...
    return promise.then((data) =>
      ListOperationsResponse.decode(new _m0.Reader(data))
    );
  }
