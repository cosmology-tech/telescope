...
export declare const QueryAccountRequest: {
    ...
    fromPartial<I extends unknown>(object: I): QueryAccountRequest;
};
export declare const QueryModuleAccountsRequest: {
    ...
    fromPartial<I extends unknown>(_: I): QueryModuleAccountsRequest;
};
...
export declare const QueryAccountResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QueryAccountResponse;
};
...
export declare const QueryModuleAccountsResponse: {
    ...
    fromPartial<I extends unknown>(object: I): QueryModuleAccountsResponse;
};
export declare const Bech32PrefixRequest: {
    ...
    fromPartial<I extends unknown>(_: I): Bech32PrefixRequest;
};
export declare const Bech32PrefixResponse: {
    ...
    fromPartial<I extends unknown>(object: I): Bech32PrefixResponse;
};
export declare const AddressBytesToStringRequest: {
    ...
    fromPartial<I extends unknown>(object: I): AddressBytesToStringRequest;
};
export declare const AddressBytesToStringResponse: {
    ...
    fromPartial<I extends unknown>(object: I): AddressBytesToStringResponse;
};
export declare const AddressStringToBytesRequest: {
    ...
    fromPartial<I extends unknown>(object: I): AddressStringToBytesRequest;
};
export declare const AddressStringToBytesResponse: {
    ...
    fromPartial<I extends unknown>(object: I): AddressStringToBytesResponse;
};
