...
export declare const TxResponse: {
    ...
    fromPartial<I extends unknown>(object: I): TxResponse;
};
export declare const ABCIMessageLog: {
    ...
    fromPartial<I extends unknown>(object: I): ABCIMessageLog;
};
export declare const StringEvent: {
    ...
    fromPartial<I extends unknown>(object: I): StringEvent;
};
...
export declare const GasInfo: {
    ...
    fromPartial<I extends unknown>(object: I): GasInfo;
};
export declare const Result: {
    ...
    fromPartial<I extends unknown>(object: I): Result;
};
export declare const SimulationResponse: {
    ...
    fromPartial<I extends unknown>(object: I): SimulationResponse;
};
export declare const MsgData: {
    ...
    fromPartial<I extends unknown>(object: I): MsgData;
};
export declare const TxMsgData: {
    ...
    fromPartial<I extends unknown>(object: I): TxMsgData;
};
export declare const SearchTxsResult: {
    ...
    fromPartial<I extends unknown>(object: I): SearchTxsResult;
};
