...
export declare const MsgSetWithdrawAddressResponse: {
    ...
    fromPartial<I extends unknown>(_: I): MsgSetWithdrawAddressResponse;
};
export declare const MsgWithdrawDelegatorReward: {
    ...
    fromPartial<I extends unknown>(object: I): MsgWithdrawDelegatorReward;
};
export declare const MsgWithdrawDelegatorRewardResponse: {
    ...
    fromPartial<I extends unknown>(object: I): MsgWithdrawDelegatorRewardResponse;
};
export declare const MsgWithdrawValidatorCommission: {
    ...
    fromPartial<I extends unknown>(object: I): MsgWithdrawValidatorCommission;
};
export declare const MsgWithdrawValidatorCommissionResponse: {
    ...
    fromPartial<I extends unknown>(object: I): MsgWithdrawValidatorCommissionResponse;
};
export declare const MsgFundCommunityPool: {
    ...
    fromPartial<I extends unknown>(object: I): MsgFundCommunityPool;
};
export declare const MsgFundCommunityPoolResponse: {
    ...
    fromPartial<I extends unknown>(_: I): MsgFundCommunityPoolResponse;
};
