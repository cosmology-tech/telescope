...
export declare const MerkleRoot: {
    ...
    fromPartial<I extends unknown>(object: I): MerkleRoot;
};
export declare const MerklePrefix: {
    ...
    fromPartial<I extends unknown>(object: I): MerklePrefix;
};
export declare const MerklePath: {
    ...
    fromPartial<I extends unknown>(object: I): MerklePath;
};
export declare const MerkleProof: {
    ...
    fromPartial<I extends unknown>(object: I): MerkleProof;
};
