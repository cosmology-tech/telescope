...
export class LoggingServiceV2ClientImpl implements LoggingServiceV2 {
  ...
  constructor(rpc: Rpc) {
    ...
    this.ListMonitoredResourceDescriptors = this.ListMonitoredResourceDescriptors.bind(this);
  ...
  DeleteLog(request: DeleteLogRequest): Promise<Empty> {
    ...
    const promise = this.rpc.request("google.logging.v2.LoggingServiceV2", "DeleteLog", data);
    return promise.then(data => Empty.decode(new _m0.Reader(data)));
  }

  WriteLogEntries(request: WriteLogEntriesRequest): Promise<WriteLogEntriesResponse> {
    const data = WriteLogEntriesRequest.encode(request).finish();
    const promise = this.rpc.request("google.logging.v2.LoggingServiceV2", "WriteLogEntries", data);
    return promise.then(data => WriteLogEntriesResponse.decode(new _m0.Reader(data)));
  }

  ListLogEntries(request: ListLogEntriesRequest): Promise<ListLogEntriesResponse> {
    const data = ListLogEntriesRequest.encode(request).finish();
    const promise = this.rpc.request("google.logging.v2.LoggingServiceV2", "ListLogEntries", data);
    return promise.then(data => ListLogEntriesResponse.decode(new _m0.Reader(data)));
  }

  ListMonitoredResourceDescriptors(request: ListMonitoredResourceDescriptorsRequest): Promise<ListMonitoredResourceDescriptorsResponse> {
    const data = ListMonitoredResourceDescriptorsRequest.encode(request).finish();
    const promise = this.rpc.request("google.logging.v2.LoggingServiceV2", "ListMonitoredResourceDescriptors", data);
    return promise.then(data => ListMonitoredResourceDescriptorsResponse.decode(new _m0.Reader(data)));
  }

  ListLogs(request: ListLogsRequest): Promise<ListLogsResponse> {
    const data = ListLogsRequest.encode(request).finish();
    const promise = this.rpc.request("google.logging.v2.LoggingServiceV2", "ListLogs", data);
    return promise.then(data => ListLogsResponse.decode(new _m0.Reader(data)));
  }

  TailLogEntries(request: Observable<TailLogEntriesRequest>): Observable<TailLogEntriesResponse> {
    const data = request.pipe(map(request => TailLogEntriesRequest.encode(request).finish()));
    const result = this.rpc.bidirectionalStreamingRequest("google.logging.v2.LoggingServiceV2", "TailLogEntries", data);
    return result.pipe(map(data => TailLogEntriesResponse.decode(new _m0.Reader(data))));
  }
